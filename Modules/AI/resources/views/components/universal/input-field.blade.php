            ...
            <div class="mb-3">
                ...
                >
                    @if(!$fieldRequired || empty($fieldValue))
                        <option value="">{{ $field['empty_option'] ?? 'Se�iniz...' }}</option>
                    @endif
        ...
        @default
            <div class="mb-3">
                <div class="alert alert-warning">
                    ...
                    Desteklenmeyen field t�r�: <code>{{ $fieldType }}</code>
                </div>
            </div>
    @endswitch
</div>
...
/* Floating labels i�in �zel stiller */
            ...
            switch (this.type) {
                case 'email':
                    if (value && !this.isValidEmail(value)) {
                        this.setFieldError('Ge�erli bir e-posta adresi giriniz.');
                        return false;
                    }
                    break;
                case 'url':
                    if (value && !this.isValidUrl(value)) {
                        this.setFieldError('Ge�erli bir URL giriniz.');
                        return false;
                    }
                    break;
            }
    ...
    Alpine.data('selectField', (name) => ({
        ...
        validateField() {
            ...
            if (field.hasAttribute('required') && !value) {
                this.setFieldError('Bu alan1 se�meniz gereklidir.');
                return false;
            }
    ...
    Alpine.data('radioField', (name) => ({
        ...
        validateField() {
            ...
            if (!isChecked && radioGroup[0].hasAttribute('required')) {
                this.setFieldError('Bu se�eneklerden birini se�melisiniz.');
                return false;
            }
    ...
    Alpine.data('fileField', (name) => ({
        ...
        validateField() {
            ...
            if (field.hasAttribute('required') && !file) {
                this.setFieldError('Dosya se�melisiniz.');
                return false;
            }
