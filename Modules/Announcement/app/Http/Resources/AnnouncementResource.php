 ...
 *
 * Transforms Announcement model for API responses.
 * Implements JSON API specification.
 *
 * @property \Modules\Announcement\App\Models\Announcement $resource
 */
class AnnouncementResource extends JsonResource
{
    ...
    /**
     * Get available locales for this announcement
     *
     * @return array<string>
     */
