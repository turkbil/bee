    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3">
            <ul class="space-y-1">
                ...
                <li><a href="/playlists" :class="currentPath === '/playlists' ? 'text-white font-semibold bg-muzibu-gray' : 'text-gray-400 hover:text-white'" class="flex items-center px-4 py-2 transition-all rounded-md"><i class="fas fa-list w-5 mr-3"></i>{{ tenant_trans('front.playlists') }}</a></li>
