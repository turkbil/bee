...
class OptimizedPromptService
{
    ...
    public static function buildSystemPrompt(): string
    {
        ...
        $prompts[] = "❌ YANLIŞ: **İXTİF F4 201 - 2.";
        $prompts[] = "            0 Ton** [LINK:...]  ← SATIR ATLAMASI YASAK! Tek satırda yaz!";
        $prompts[] = "```";
        $prompts[] = "";
        $prompts[] = "**MUTLAKA:**";
        $prompts[] = "- ÜRÜN ADI + LINK TEK SATIRDA OLMALI!";
        $prompts[] = "- Title ile link arasında SATIR ATLAMASI (\\n) YASAK!";
        $prompts[] = "- Önce ** ile ürün adını sar";
        $prompts[] = "- Sonra boşluk bırak";
        $prompts[] = "- Sonra [LINK:shop:slug] ekle";
        $prompts[] = "- Tümü TEK SATIRDA!";
        ...
        $prompts[] = "";
        $prompts[] = "**ÖRNEK DOGRU FORMAT:**";
        $prompts[] = "```";
        $prompts[] = "**İXTİF F4 201 - 2.0 Ton Li-Ion Transpalet** [LINK:shop:ixtif-f4-201-20-ton-li-ion-transpalet]";
        $prompts[] = "^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^";
        $prompts[] = "TÜMÜ TEK SATIRDA! SATIR ATLAMASI YOK!";
        $prompts[] = "```";
        $prompts[] = "";
        $prompts[] = "";
        ...
        $prompts[] = "⚠️ ⚠️ ⚠️ ULTRA KRİTİK YASAK! ⚠️ ⚠️ ⚠️";
        $prompts[] = "";
        $prompts[] = "🚨 ASLA TITLE KISALTMA! ASLA DEĞİŞTİRME! ASLA DÜZENLEME!";
        $prompts[] = "🚨 Sana verilen TITLE'ı KELİME KELİME, HARF HARF, NOKTA NOKTA AYNEN KOPYALA!";
        $prompts[] = "";
        $prompts[] = "```";
        $prompts[] = "✅ DOĞRU (Title'ı AYNEN kopyala):";
        ...
        $prompts[] = "                 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^";
        $prompts[] = "                 HER KARAKTER AYNI!";
        $prompts[] = "";
        $prompts[] = "DB'den gelen: \"İXTİF F4 201 - 2.0 Ton Li-Ion Transpalet\"";
        $prompts[] = "Sen yazacaksın: **İXTİF F4 201 - 2.0 Ton Li-Ion Transpalet** [LINK:shop:slug]";
        $prompts[] = "                 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^";
        $prompts[] = "                 AYNEN KOPYALA!";
        $prompts[] = "";
        ...
        $prompts[] = "                 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^";
        $prompts[] = "                 \"1200\" AYNEN KOPYALA!";
        $prompts[] = "";
        $prompts[] = "❌❌❌ ASLA YAPMA (YASAK!):";
        $prompts[] = "DB'den gelen: \"İXTİF EFL302X4 - 3.0 Ton Forklift\"";
        $prompts[] = "Sen yazıyorsun: **İXTİF EFL302X4 - 3. Ton Forklift**  ← \"3.0\" → \"3.\" YASAK!!!";
        $prompts[] = "Sen yazıyorsun: **İXTİF EFL302X4 - 3 Ton Forklift**  ← \".0\" silmek YASAK!!!";
        $prompts[] = "";
        $prompts[] = "DB'den gelen: \"İXTİF F4 201 - 2.0 Ton Li-Ion Transpalet\"";
        $prompts[] = "Sen yazıyorsun: **İXTİF F4 201 - 2.** [LINK:...]  ← KESME YASAK!!!";
        $prompts[] = "Sen yazıyorsun: **İXTİF F4 201 - 2 Ton** [LINK:...]  ← KISA YAZMA YASAK!!!";
        $prompts[] = "";
        $prompts[] = "DB'den gelen: \"İXTİF JX1-HD - 1200 lb Süper Görev\"";
        $prompts[] = "Sen yazıyorsun: **İXTİF JX1-HD - 120 lb Süper Görev**  ← \"1200\" → \"120\" YASAK!!!";
        $prompts[] = "```";
        $prompts[] = "";
        $prompts[] = "📌 MUTLAK KURAL:";
        $prompts[] = "1. Title'ı CTRL+C / CTRL+V yap gibi AYNEN KOPYALA!";
        $prompts[] = "2. Tek karakter bile değiştirme, kısaltma, silme!";
        $prompts[] = "3. Sayıları değiştirme: \"3.0\" AYNEN \"3.0\" olmalı (\"3.\" veya \"3\" YASAK!)";
        $prompts[] = "4. Title'ı yarıda kesme: Tam adı yaz!";
        $prompts[] = "5. Bu kural ihlal edilirse YANIT GEÇERSİZ SAYILIR!";
        $prompts[] = "";
