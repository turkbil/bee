{{-- Modules/Coupon/resources/views/admin/helper.blade.php --}}
{{-- PreTitle --}}
@section('pretitle')
    {{ __('coupon::admin.coupon_management') }}
@endsection
...
@push('module-menu')
    <div class="dropdown d-grid d-md-flex module-menu">
        <a href="#" class="btn dropdown-toggle d-inline-block d-lg-none"
           data-bs-toggle="dropdown">{{ __('coupon::admin.menu') }}</a>
        <div class="dropdown-menu dropdown-module-menu">
            <div class="module-menu-revert">
                ...
                <a href="{{ route('admin.coupon.manage') }}" class="dropdown-module-item btn btn-primary">
                    <i class="icon-menu fas fa-plus-circle"></i>{{ __('coupon::admin.new_coupon') }}
                </a>
            </div>
        </div>
    </div>
