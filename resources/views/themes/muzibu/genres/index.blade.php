...
<div class="px-6 py-8">
    ...
    <div class="mb-8 flex items-center gap-5">
        <div class="w-16 h-16 bg-white/10 rounded-xl flex items-center justify-center flex-shrink-0">
            <i class="fas fa-guitars text-3xl text-white fa-beat-fade" style="--fa-animation-duration: 2s; --fa-beat-fade-opacity: 0.4; --fa-beat-fade-scale: 1.1;"></i>
        </div>
        <div>
            <h1 class="text-5xl font-extrabold text-white mb-1">Türler</h1>
            <p class="text-gray-400 text-lg">Müzik türlerini keşfet</p>
        </div>
    </div>
