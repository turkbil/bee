...
class JX1_HD_Siparis_3_Variants extends Seeder {
    public function run(): void {
        ...
        if (!$m) {$this->command->error('❌ Master bulunamadı (JX1-HD)'); return; }
        ...
        $variants = [
            ...
            [
                ...
                'long_description' => '<section><h3>Maksimum Erişim</h3><p>Bu varyant, 210 inç operatör yükseltmesi ile çok katlı raflara güvenli erişim sağlar. 248.8 inç kaldırma ve 288.8 inç mast tam açık yüksekliği; yüksek arşiv, yedek parça ve e-ticaret uygulamalarında planlamayı kolaylaştırır.</p></section><section><h3>Teknik Odak</h3><p>63 inç dönüş yarıçapı dar koridorlarda çeviklik sunarken AC sürüş ve rejeneratif fren, hızlanma ve yavaşlamayı kontrollü hale getirir. Poly tekerlekler düz ve pürüzsüz yüzeylerde sessiz ve verimlidir.</p></section><section><h3>Sonuç</h3><p>Yüksek erişim gerektiren operasyonlarda toplama verimini artırmak için geliştirilmiştir.</p></section>',
                'use_cases' => [
