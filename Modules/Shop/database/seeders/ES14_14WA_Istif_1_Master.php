...
class ES14_14WA_Istif_1_Master extends Seeder {
    public function run(): void {
        $categoryId = 3;
        $brandId = 1;
        $sku = 'ES14-14WA';
        $titleTr = 'İXTİF ES14-14WA - 1.4 Ton Elektrikli Yaya Tipi İstif Makinesi';

        DB::table('shop_products')->updateOrInsert(['sku' => $sku], [
            'sku' => $sku,
            'title' => json_encode(['tr' => $titleTr], JSON_UNESCAPED_UNICODE),
            'slug' => json_encode(['tr' => Str::slug($titleTr)], JSON_UNESCAPED_UNICODE),
            'short_description' => json_encode(['tr' => '1400 kg kapasite, 600 mm yük merkezi ve 5.0 / 5.5 km/s (yüklü/boş) seyir hızıyla dar koridorlarda çevik istifleme. 800 mm gövde genişliği, 1589 mm dönüş yarıçapı ve 24V 210Ah (190 kg) enerji sistemiyle gün boyu verimli operasyon; iki kademeli indirme hassasiyeti.'], JSON_UNESCAPED_UNICODE),
            'base_price' => 0.00,
