...
use Modules\Payment\App\Contracts\PaymentCategoryRepositoryInterface;
use Modules\Payment\App\Models\PaymentCategory;
use Modules\Payment\App\Enums\CacheStrategy;

readonly class PaymentCategoryRepository implements PaymentCategoryRepositoryInterface
{
    ...
    public function __construct(
        private PaymentCategory $model
    ) {
        $this->cachePrefix = 'payment_categories';
