    ...
    public function run(): void {
        ...
        $variants = [
            [
                ...
                'long_description' => '<section><h2>İXTİF EFL403-HV 1220 mm Çatal</h2><p>1220 mm çatal, hacimli yüklerde ağırlık dağılımını iyileştirerek mast stresini azaltır. Açık alan sevkiyatlarında rüzgâr etkisine karşı yük stabilitesini artırır; hidrolik yağ soğutma ardışık kaldırmalarda ısınmayı kontrol eder. Telemetri ve çevrimiçi destek, performans parametrelerini izleyip proaktif bakım sağlar.</p></section><section><h3>Teknik</h3><p>1220 mm çatal, hacimli yüklerde ağırlık dağılımını iyileştirerek mast stresini azaltır. Açık alan sevkiyatlarında rüzgâr etkisine karşı yük stabilitesini artırır; hidrolik yağ soğutma ardışık kaldırmalarda ısınmayı kontrol eder. Telemetri ve çevrimiçi destek, performans parametrelerini izleyip proaktif bakım sağlar. Teknik odakta; 309V/173Ah, 24/25 km/s ve %25/%30 gibi veriler, senaryonun gerektirdiği hız ve tırmanmayı sağlar.</p></section><section><h3>Sonuç</h3><p>0216 755 3 555</p></section>',
                'use_cases' => [
                ['icon' => 'box-open', 'text' => 'Standart EUR paletlerde hızlı giriş-çıkış (kapı/koridor)'],
                ['icon' => 'warehouse', 'text' => 'Dar raf aralıklarında konumlama ve düzeltme'],
                ['icon' => 'car', 'text' => 'Treyler ve rampa üstü yükleme/boşaltma'],
