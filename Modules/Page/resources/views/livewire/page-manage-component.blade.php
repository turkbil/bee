    ...
    <form wire:submit.prevent="save">
        <div class="card">
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tabs-2">
                        ...
                        <div class="form-floating mb-3">
                            <textarea
                                wire:model.defer="inputs.metadesc"
                    ...
                    <div class="tab-pane fade" id="tabs-3">
                        <div class="form-floating mb-3">
                            <textarea
                                wire:model.defer="inputs.css"
                                class="form-control @error('inputs.css') is-invalid @enderror"
                                data-bs-toggle="autosize"
                        ...
                        <div class="form-floating mb-3">
                            <textarea
                                wire:model.defer="inputs.js"
                                class="form-control @error('inputs.js') is-invalid @enderror"
                                data-bs-toggle="autosize"
            ...
            <div class="card-footer d-flex justify-content-between align-items-center">
                <a href="{{ route('admin.page.index') }}" class="btn">İptal</a>
