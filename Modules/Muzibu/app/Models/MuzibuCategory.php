...
class MuzibuCategory extends BaseModel implements TranslatableEntity, HasMedia
{
     ...
     * Muzibus ilişkisi
     */
    public function muzibus()
    {
        return $this->hasMany(Muzibu::class, 'muzibu_category_id', 'category_id');
    }
    ...
    public function getSeoFallbackCanonicalUrl(): ?string
    {
        ...
        if ($slug) {
            return url('/muzibu/category/' . ltrim($slug, '/'));
        }
    ...
    {
        \Log::info("Muzibu Category çevirisi tamamlandı", [
            'category_id' => $this->category_id,
    ...
    {
        return \Modules\Muzibu\Database\Factories\MuzibuCategoryFactory::new();
    }
