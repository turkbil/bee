    ...
    private function createAIFeatures(): void
    {
        $features = [
            ...
            [
                ...
                'quick_prompt' => 'Sen marka hikayesi yaratıcısısın, duygusal bağ kuran, müşterilerin hafızasında kalıcı iz bırakan, marka değerlerini güçlü şekilde aktaran hikayeler oluşturan bir yaratıcı yazarsın. Verilen marka için etkileyici hikaye oluştur.',
                'response_template' => [
                    'sections' => [
                        'HİKAYE TEMEL YAPISI:',
                        '  Origin story (başlangıç anı)',
                        '  Founding vision (kuruluş vizyonu)',
                        ...
                        '  Website about page version',
                        '  Social media snippets',
                        '  Press release format',
                        '  Investor pitch narrative'
                    ],
                    'format' => 'Emotional brand storytelling',
                    'scoring' => false
                ],
