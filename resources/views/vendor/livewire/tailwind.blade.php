...
<div class="card-footer d-flex flex-column flex-md-row align-items-center">
    ...
    <p class="small text-muted m-0 text-center text-md-start">
        {{ __('admin.pagination_showing') }} <span class="fw-semibold">{{ $paginator->firstItem() }}</span> {{ __('admin.pagination_to') }}
        <span class="fw-semibold">{{ $paginator->lastItem() }}</span>
        {{ __('admin.pagination_between') }}, {{ __('admin.pagination_of') }} <span class="fw-semibold">{{ $paginator->total() }}</span> {{ __('admin.pagination_results') }}
    </p>
