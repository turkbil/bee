    ...
    public function run(): void
    {
        ...
        $variants = [
            ...
            [
                ...
                'body' => '<section><h3>2.713 mm Direk: Esnek raf düzenine uygun istif</h3><p>Bu konfigürasyon, koridor optimizasyonu yapılmış tesislerde maksimum hacim verimliliği hedefleyen ekipler için geliştirilmiştir. Kaldırma yüksekliği 2.713 mm’ye uzanırken, kapalı direk ölçüleri kapı ve rampa geçişlerinde sorun çıkarmaz. EN 16796’ya göre 0.57 kWh/h tüketim, işletme maliyetlerini kontrol altında tutar.</p><p>AGM akü kimyası günlük depo operasyonlarına iyi uyum sağlar; entegre şarj cihazı ile altyapı gereksinimi düşüktür. Mekanik direksiyon ve elektromanyetik fren, sezgisel kullanım ve güvenli duruşla operatör yorgunluğunu azaltır.</p></section><section><h3>Uygulama alanları</h3><p>Hızlı ürün devirli raflar, e-ticaret backroom ve 3PL bölümlerinde etkin çözüm üretir; yoğun vardiyalarda mola şarjlarıyla süreklilik korunur.</p></section>',
                'use_cases' => [
