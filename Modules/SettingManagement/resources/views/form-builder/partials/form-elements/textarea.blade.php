@php
    ...
    $fieldName = isset($element['name']) ? $element['name'] : (isset($element['properties']['name']) ? $element['properties']['name'] : 'textarea_' . uniqid());
    $fieldLabel = isset($element['label']) ? $element['label'] : (isset($element['properties']['label']) ? $element['properties']['label'] : 'Uzun Metin');
    ...
    $rows = isset($element['rows']) ? $element['rows'] : (isset($element['properties']['rows']) ? $element['properties']['rows'] : 3);
    ...
    <div class="mb-3">
        <div class="form-floating">
            <textarea 
                ...
                rows="{{ $rows }}"
                style="height: {{ (int)$rows * 30 + 30 }}px"
