...
class EFX5_351_Forklift_3_Variants extends Seeder {
    public function run(): void {
        $m = DB::table('shop_products')->where('sku', 'EFX5-351')->first();
        if (!$m) {$this->command->error('❌ Master bulunamadı: EFX5-351'); return; }
        ...
        $variants = [
            ...
            [
                ...
                'title' => 'İXTİF EFX5 351 - 80V 280Ah Tek Modül',
                ...
                'long_description' => '<section><h3>Enerji ve Performans</h3><p>80V 280Ah tek modül Li-Ion, hafif ve orta yoğunluklu vardiyalarda hızlı fırsat şarjıyla sürekli hazır kalır. AC sürüş ve kaldırma sistemi, dar koridorlarda hassas manevra ve istikrarlı hız sağlar.</p></section>
...
JSON
        ...
        ,
            ...
            [
                'sku' => 'EFX5-351-B560',
                'variant_type' => 'batarya-tipi',
                'title' => 'İXTİF EFX5 351 - 80V 560Ah Çift Modül',
                ...
                'long_description' => '<section><h3>Yüksek Dayanım</h3><p>İki adet 80V 280Ah modül, toplam 560Ah kapasite sağlar. Yoğun vardiyalarda dahi akış kesintiye uğramadan devam eder; şarj molaları operasyon planına uyumlu şekilde kısalır.</p></section>
...
JSON
        ...
        ,
            ...
            [
                ...
                'title' => 'İXTİF EFX5 351 - 4.5 m Direk',
                ...
                'long_description' => '<section><h3>Direk Seçeneği</h3><p>Yaklaşık 4500 mm kaldırma yüksekliği, orta-yüksek raf uygulamalarında daha fazla esneklik sunar. Geliştirilmiş görüş profili, palet hizalama hatalarını azaltır.</p></section>
