                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            {{ __('usermanagement::admin.basic_permission_settings') }}
                        </h3>
                    </div>
                    <div class="card-body">
                        <!-- Guard Name -->
                        <div class="mb-4">
                            <div class="form-floating">
                                <select wire:model.defer="inputs.guard_name"
                                    ...
                                    data-choices-placeholder="{{ __('usermanagement::admin.select_guard_type') }}">
                                    <option value="admin" selected>{{ __('usermanagement::admin.admin_guard') }}</option>
                                    <option value="web">{{ __('usermanagement::admin.web_guard') }}</option>
                                    <option value="api">{{ __('usermanagement::admin.api_guard') }}</option>
                                </select>
                                <label>{{ __('usermanagement::admin.permission_guard_type') }}</label>
                                @error('inputs.guard_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <small class="text-muted">{{ __('usermanagement::admin.guard_area_text') }}</small>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="form-floating">
                                <input type="text" wire:model.defer="inputs.module_name"
                                    ...
                                    placeholder="{{ __('usermanagement::admin.module_name_placeholder') }}">
                                <label>{{ __('usermanagement::admin.module_name') }}</label>
                                @error('inputs.module_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <small class="text-muted">{{ __('usermanagement::admin.module_permission_text') }}</small>
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="form-label d-block">
                                ...
                                {{ __('usermanagement::admin.crud_operations') }}
                            </label>
                            <div class="row g-2">
                                @foreach([
                                'view' => ['icon' => 'eye', 'color' => 'info', 'text' => __('usermanagement::admin.view')],
                                'create' => ['icon' => 'plus', 'color' => 'success', 'text' => __('usermanagement::admin.create')],
                                'update' => ['icon' => 'edit', 'color' => 'warning', 'text' => __('usermanagement::admin.update')],
                                'delete' => ['icon' => 'trash', 'color' => 'danger', 'text' => __('usermanagement::admin.delete')]
                                ] as $type => $attrs)
<div class="col-6 mb-2">
    <div class="pretty p-default p-curve p-toggle p-smooth ms-1">
        ...
        <div class="state p-danger p-off ms-2">
                ...
                {{ $attrs['text'] }}
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <button type="button" class="btn btn-primary w-100" wire:loading.attr="disabled"
                                ...
                                {{ __('usermanagement::admin.generate_permissions') }}
            ...
            <!-- Sağ Kolon - {{ __('usermanagement::admin.generated_permissions') }} -->
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-list-check text-green me-2"></i>
                            {{ __('usermanagement::admin.generated_permissions') }}
                        </h3>
                        <div class="card-actions">
                            <span class="badge bg-blue">{{ __('usermanagement::admin.permissions_count', ['count' => count($generatedPermissions)]) }}</span>
                        </div>
                    </div>
                    <div class="card-body">
                        <!-- Manuel Yetki Ekleme -->
                        <div class="mb-4">
                            <div class="form-floating mb-2">
                                <input type="text" wire:model.defer="manualPermission"
                                    ...
                                    placeholder="{{ __('usermanagement::admin.custom_permission_placeholder') }}">
                                <label>{{ __('usermanagement::admin.add_custom_permission') }}</label>
                            ...
                            <button type="button" class="btn btn-outline-primary btn-sm w-100"
                                ...
                                {{ __('usermanagement::admin.add_custom_permission') }}
                            </button>
                        </div>
                        ...
                        <div class="empty">
                            ...
                            <p class="empty-title">{{ __('usermanagement::admin.no_permissions_yet') }}</p>
                            <p class="empty-subtitle text-muted">
                                {{ __('usermanagement::admin.module_permission_create_text') }}
                            </p>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="card-footer d-flex justify-content-between align-items-center">
                        <div class="text-muted small">
                            {{ __('usermanagement::admin.total_permissions_created', ['count' => count($generatedPermissions)]) }}
                        </div>
                        <div>
                            <button type="submit" class="btn btn-success" wire:loading.attr="disabled">
                                <i class="fas fa-save me-2"></i>
                                {{ __('usermanagement::admin.save_permissions') }}
