...
class JX0_Siparis_3_Variants extends Seeder {
    public function run(): void {
        $m = DB::table('shop_products')->where('sku', 'JX0')->first();
        if (!$m) {$this->command->error('❌ Master bulunamadı: JX0'); return; }
        $variants = json_decode(<<<'JSON'
            [
                {
                    "sku": "JX0-LI135",
                    "variant_type": "batarya-tipi",
                    "title": "İXTİF JX0 - Li-Ion 24V/135Ah",
                ...
                },
                {
                    "sku": "JX0-LA120",
                    "variant_type": "batarya-tipi",
                    "title": "İXTİF JX0 - Kurşun Asit 24V/120Ah",
