...
class SectorSeeder_Part3 extends Seeder
{
    ...
    private function addServiceSectors(): void
    {
        ...
        $sectors = [
            // HİZMET SEKTÖRLERI (ID 179-190) - Hizmet kategorisine (ID 9) dahil
            ['id' => 179, 'code' => 'cleaning_services', 'category_id' => 9, 'name' => 'Temizlik Hizmetleri', 'emoji' => '🧽', 'color' => 'blue', 'description' => 'Ev, ofis, endüstriyel temizlik', 'keywords' => 'temizlik, cleaning, ev, ofis'],
            ['id' => 180, 'code' => 'security_services', 'category_id' => 9, 'name' => 'Güvenlik Hizmetleri', 'emoji' => '🛡️', 'color' => 'red', 'description' => 'Güvenlik, kamera sistemi, alarm', 'keywords' => 'güvenlik, security, kamera, alarm'],
            ['id' => 181, 'code' => 'logistics_cargo', 'category_id' => 9, 'name' => 'Lojistik & Kargo', 'emoji' => '📦', 'color' => 'orange', 'description' => 'Kargo, nakliye, depolama', 'keywords' => 'kargo, lojistik, nakliye, depo'],
            ['id' => 182, 'code' => 'wedding_events', 'category_id' => 9, 'name' => 'Düğün & Etkinlik', 'emoji' => '💒', 'color' => 'pink', 'description' => 'Düğün organizasyonu, etkinlik', 'keywords' => 'düğün, etkinlik, organizasyon, event'],
            ['id' => 183, 'code' => 'translation_services', 'category_id' => 9, 'name' => 'Çeviri & Tercümanlık', 'emoji' => '🗣️', 'color' => 'purple', 'description' => 'Çeviri, tercümanlık, noter', 'keywords' => 'çeviri, tercüman, translation, noter'],
            ['id' => 184, 'code' => 'consulting_services', 'category_id' => 11, 'name' => 'Danışmanlık Hizmetleri', 'emoji' => '💼', 'color' => 'blue', 'description' => 'İş danışmanlığı, strateji, yönetim', 'keywords' => 'danışmanlık, consulting, strateji, yönetim'],
            ['id' => 185, 'code' => 'repair_technical', 'category_id' => 9, 'name' => 'Teknik Servis & Tamir', 'emoji' => '🔧', 'color' => 'gray', 'description' => 'Elektronik tamir, teknik servis', 'keywords' => 'tamir, servis, teknik, elektronik'],
            ...
            ['id' => 187, 'code' => 'advertising_agency', 'category_id' => 5, 'name' => 'Reklam Ajansı', 'emoji' => '📢', 'color' => 'red', 'description' => 'Reklam, kreatif, marka yönetimi', 'keywords' => 'reklam, ajans, kreatif, marka'],
            ...
            // ESNAF SEKTÖRLERI (ID 191-200) - Kişisel Bakım (ID 14) kategorisine dahil  
            ...
            ['id' => 196, 'code' => 'key_locksmith', 'category_id' => 9, 'name' => 'Anahtar & Çilingir', 'emoji' => '🔑', 'color' => 'yellow', 'description' => 'Anahtar çoğaltma, çilingir', 'keywords' => 'anahtar, çilingir, kilit, çoğaltma'],
            ...
            ['id' => 198, 'code' => 'phone_repair', 'category_id' => 1, 'name' => 'Telefon Tamiri', 'emoji' => '📱', 'color' => 'green', 'description' => 'Telefon tamiri, ekran değişimi', 'keywords' => 'telefon, tamir, ekran, phone'],
