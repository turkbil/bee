...
@section('module_content')
    @php
        ...
        $breadcrumbsArray = [
            ...
            ['label' => $moduleTitle ?? 'Hizmetlerimiz']
        ];
    @endphp
    ...
    <section class="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div class="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 py-4">
            ...
            <h1 class="text-2xl md:text-3xl font-bold font-heading text-gray-900 dark:text-white">{{ $moduleTitle ?? 'Hizmetlerimiz' }}</h1>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
            ...
            @else
                ...
                <div class="text-center py-16">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm font-body">Yakında hizmetlerimiz burada listelenecek.</p>
                </div>
            @endif
        </div>
    </section>
