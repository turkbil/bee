...
<div wire:key="shop-category-component" wire:id="shop-category-component">
    {{-- Helper dosyası --}}
    @include('shop::admin.helper-category')
                            ...
                            <div class="tab-pane fade show active" id="0" role="tabpanel">
                                    ...
                                    <div class="language-content" data-language="{{ $lang }}"
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text"
                                                ...
                                                placeholder="{{ __('shop::admin.category_title') }}">
                                            <label>
                                                {{ __('shop::admin.category_title') }}
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-select" wire:model.defer="parent_id">
                                        <option value="">{{ __('shop::admin.main_category') }}</option>
                                    ...
                                    <label>{{ __('shop::admin.parent_category') }}</label>
                                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <!-- Dinamik Başlık - Sol -->
                        <div class="col">
                            <h3 class="card-title mb-0">{{ __('shop::admin.categories') }}</h3>
                            <p class="text-muted small mb-0">{{ __('shop::admin.category_management') }}</p>
                        </div>
                        <!-- Ortadaki Loading -->
                            ...
                            <div class="d-flex align-items-center justify-content-end">
                                <div class="input-icon">
                                    ...
                                    <input type="text" wire:model.live.debounce.300ms="search" class="form-control"
                                        placeholder="{{ __('shop::admin.search_categories') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            @empty
                                <div class="list-group-item py-4">
                                    <div class="empty">
                                        ...
                                        <p class="empty-title mt-2">{{ __('shop::admin.no_categories_found') }}</p>
                                        <p class="empty-subtitle text-muted">{{ __('shop::admin.no_results') }}</p>
                                    </div>
                                </div>
                            @endforelse
                        </div>
