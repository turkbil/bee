                ...
                <div class="flex flex-col md:flex-row gap-8 items-start">
                    ...
                    <div class="w-full md:w-5/12 space-y-6">
                        ...
                        <a href="tel:02167553555"
                           class="group flex items-start gap-4 p-6 bg-white/10 backdrop-blur-sm hover:bg-white/20 rounded-2xl transition-all border border-white/20">
                        ...
                        <a href="mailto:info@ixtif.com"
                           class="group flex items-start gap-4 p-6 bg-white/10 backdrop-blur-sm hover:bg-white/20 rounded-2xl transition-all border border-white/20">
                            <div class="w-14 h-14 bg-purple-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
