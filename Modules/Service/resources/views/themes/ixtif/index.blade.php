...
@section('module_content')
    <div class="relative" x-data="servicesList()" x-init="init()">

        {{-- Glass Subheader Component --}}
        @php
            $breadcrumbs = [
                ['label' => __('service::front.general.home'), 'url' => url('/'), 'icon' => 'fa-home'],
                ['label' => $moduleTitle ?? __('service::front.general.services')]
            ];
        @endphp

        @subheader([
            'title' => $moduleTitle ?? __('service::front.general.services'),
                    ...
                    <div class="text-center py-20" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
                        <div x-show="show" x-transition:enter="transition ease-out duration-500"
                            ...
                            <p class="text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
                                {{ __('service::front.general.no_services_found') }}</p>
                        </div>
                    </div>
                @endif
            </div>
