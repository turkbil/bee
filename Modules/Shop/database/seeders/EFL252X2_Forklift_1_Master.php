...
class EFL252X2_Forklift_1_Master extends Seeder {
    public function run(): void {
        $sku = 'EFL-252X2';
        $titleTr = 'İXTİF EFL252X2 - 2.5 Ton Li-Ion Denge Ağırlıklı Forklift';
            ...
            'technical_specs' => json_encode(json_decode(<<<'JSON'
                {
                    ...
                    "Çatala Kadar Uzunluk (l2)": "2528 mm",
                    ...
                    "Direk/Serbest Kaldırma Seçenekleri": "3000, 3300, 3500, 3600, 4000 mm standart; 4300-4800 mm serbest kaldırma seçenekleri"
                }
JSON
