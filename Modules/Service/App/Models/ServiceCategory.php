...
class ServiceCategory extends BaseModel implements TranslatableEntity, HasMedia
{
    ...
    {
        return $this->hasMany(Service::class, 'service_category_id', 'category_id');
    }
    ...
    public function getSeoFallbackCanonicalUrl(): ?string
    {
        ...
        if ($slug) {
            return url('/service/category/' . ltrim($slug, '/'));
        }
    ...
    {
        \Log::info("Service Category çevirisi tamamlandı", [
            'category_id' => $this->category_id,
