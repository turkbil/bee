...
class ReviewSystem extends BaseModel implements TranslatableEntity, HasMedia
{
    use Sluggable, HasTranslations, HasSeo, HasFactory, HasMediaManagement;

    protected $primaryKey = 'reviewsystem_id';
    ...
    /**
     * ID accessor - reviewsystem_id'yi id olarak döndür
     */
    public function getIdAttribute()
    {
        return $this->reviewsystem_id;
    }
    ...
    {
        // Check if reviewsystem has any images in content
        $content = $this->getTranslated('body', app()->getLocale()) ?? $this->body;
    ...
    /**
     * Get or create SEO setting for this reviewsystem
     */
    ...
    {
        // ReviewSystem modülü için özel işlemler burada yapılabilir
        // Örneğin: Cache temizleme, sitemap güncelleme vb.

        \Log::info("ReviewSystem çevirisi tamamlandı", [
            'reviewsystem_id' => $this->reviewsystem_id,
    ...
    {
        return \Modules\ReviewSystem\Database\Factories\ReviewSystemFactory::new();
    }
    ...
    /**
     * ReviewSystem için locale-aware URL oluştur
    ...
    public function getUrl(?string $locale = null): string
    {
        ...
        $moduleSlug = \App\Services\ModuleSlugService::getSlug('ReviewSystem', 'show');
