...
class ES16_16WA_Istif_3_Variants extends Seeder
{
    public function run(): void
    {
        $m = DB::table('shop_products')->where('sku', 'ES16-16WA')->first();
        if (!$m) {
        ...
        $variants = [
            [
                'sku' => 'ES16-16WA-1150-550',
                'variant_type' => 'catal-uzunlugu',
                'title' => 'İXTİF ES16-16WA - 1150 mm Çatal / 550 mm Aralık',
                ...
                'body' => '<section><h2>1150 mm Çatal - 550 mm Açıklık: Hız ve Çeviklik</h2>
...
JSON,
            ...
            [
                'sku' => 'ES16-16WA-1220-685',
                'variant_type' => 'catal-uzunlugu',
                'title' => 'İXTİF ES16-16WA - 1220 mm Çatal / 685 mm Aralık',
                ...
                'body' => '<section><h2>1220 mm Çatal - 685 mm Açıklık: Uzun Yüklerde Stabilite</h2>
...
JSON,
        ...
        $this->command->info('✅ Variants eklendi/güncellendi: ES16-16WA');
    }
}
