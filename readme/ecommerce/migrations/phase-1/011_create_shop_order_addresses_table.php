...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('shop_order_addresses', function (Blueprint $table) {
            ...
            $table->index('address_type', 'idx_type');
            $table->index(['order_id', 'address_type'], 'idx_order_type');
        ...
        ->comment('Sipariş adresleri - Fatura ve teslimat adresleri snapshot (değişmez kayıt)');
    }
