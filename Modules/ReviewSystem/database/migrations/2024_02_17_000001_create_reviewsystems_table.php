...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('reviewsystems', function (Blueprint $table) {
            ...
            $table->index(['is_active', 'deleted_at', 'created_at'], 'reviewsystems_active_deleted_created_idx');
            $table->index(['is_active', 'deleted_at'], 'reviewsystems_active_deleted_idx');
        });
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('reviewsystems');
    }
};