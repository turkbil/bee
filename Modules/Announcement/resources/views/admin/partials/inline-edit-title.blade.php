        ...
        <div class="d-flex align-items-center gap-3" x-data @click.outside="$wire.updateTitleInline()">
            <div class="flexible-input-wrapper">
                <input type="text"
                       ...
                       placeholder="{{ __('announcement::admin.enter_new_title') }}"
    ...
    @else
        <div class="d-flex align-items-center">
            ...
            <button class="btn btn-sm px-2 py-1 edit-icon ms-4"
                wire:click="startEditingTitle({{ $announcement->announcement_id }}, '{{ addslashes($announcement->getTranslated('title')) }}')">
