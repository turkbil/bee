<div>
    @php
        View::share(
            'pretitle',
            $categoryId ? __('payment::admin.edit_category') : __('payment::admin.new_category'),
        );
    @endphp
    ...
    <form method="post" wire:submit.prevent="save">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="tab-content" id="contentTabContent">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12 col-md-6 mb-3 mb-md-0">
                                <div class="form-floating">
                                    ...
                                    <label for="parent_category_select">
                                        {{ __('payment::admin.parent_category') }}
                                    </label>
                            ...
                            <div class="col-12 col-md-6 category-media-wrapper">
                                <livewire:mediamanagement::universal-media
                                    ...
                                    :model-id="$categoryId"
                                    model-type="payment_category"
                                    model-class="Modules\Payment\App\Models\PaymentCategory"
                        ...
                        @foreach ($availableLanguages as $lang)
                            ...
                            <div class="language-content" data-language="{{ $lang }}"
                                ...
                                @include('admin.components.content-editor', [
                                    ...
                                    'label' => __('payment::admin.category_description'),
                                    'placeholder' => __('payment::admin.category_description_placeholder'),
                                ])
                            </div>
                        @endforeach
                    ...
                    <div class="tab-pane" id="1" role="tabpanel">
                        <livewire:seomanagement::universal-seo-tab :model-id="$categoryId" model-type="payment_category"
                            model-class="Modules\Payment\App\Models\PaymentCategory" />
                    </div>
            ...
            <x-form-footer route="admin.payment.category.index" :model-id="$categoryId" />
    ...
    @push('scripts')
        ...
        <script>
            ...
            window.currentModuleName = 'payment_category';
