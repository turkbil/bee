...
readonly class ShopOperationResult
{
    public function __construct(
        public bool $success,
        public string $message,
        public string $type = 'success',
        public ?ShopProduct $data = null,
        public ?array $meta = null
    ) {}

    public static function success(string $message, ?ShopProduct $data = null, ?array $meta = null): self
    {
        return new self(
            success: true,
            message: $message,
