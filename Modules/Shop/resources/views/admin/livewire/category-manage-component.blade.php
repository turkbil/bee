<div>
    @php
        View::share(
            'pretitle',
            $categoryId ? __('shop::admin.edit_category') : __('shop::admin.new_category'),
        );
    @endphp
    ...
    <form method="post" wire:submit.prevent="save">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="tab-content" id="contentTabContent">
                        ...
                        @foreach ($availableLanguages as $lang)
                            ...
                            <div class="language-content" data-language="{{ $lang }}"
                                ...
                                @include('admin.components.content-editor', [
                                    ...
                                    'label' => __('shop::admin.category_description'),
                                    'placeholder' => __('shop::admin.category_description_placeholder'),
                                ])
                            </div>
                        @endforeach
                    ...
                    <div class="tab-pane" id="1" role="tabpanel">
                        <livewire:seomanagement::universal-seo-tab :model-id="$categoryId" model-type="shop_category"
                            model-class="Modules\Shop\App\Models\ShopCategory" />
                    </div>
            ...
            <x-form-footer route="admin.shop.categories.index" :model-id="$categoryId" />
    ...
    @push('scripts')
        ...
        <script>
            ...
            window.currentModuleName = 'shop_category';
