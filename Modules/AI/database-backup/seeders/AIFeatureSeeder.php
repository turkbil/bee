...
- Free trial conversion',
    ...
    {
        // Kategori mapping'i (eski category -> yeni category_id)
        $categoryMapping = [
            'content-creation' => 1,    // İçerik Üretimi
            'marketing' => 2,           // Pazarlama
            'legal' => 10,              // Diğer
            'technical' => 8,           // Kod & Teknoloji
            'creative' => 7,            // Yaratıcılık & Sanat
            'communication' => 2,       // Pazarlama
            'business' => 5             // İş & Finans
        ];
        ...
        foreach ($features as $featureData) {
            ...
            $feature = AIFeature::create([
                ...
                'ai_feature_category_id' => $featureData['ai_feature_category_id'],
