                            ...
                            <tr class="hover-trigger" wire:key="row-{{ $album->album_id }}">
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-flex align-items-center gap-3 justify-content-center">
                                        <a href="{{ route('admin.album.manage', $album->album_id) }}"
                                        ...
                                        <a href="{{ route('admin.studio.editor', ['module' => 'album', 'id' => $album->album_id]) }}"
                                            target="_blank" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="{{ __('muzibu::admin.album.studio.editor') }}"
                                            style="min-height: 24px; display: inline-flex; align-items: center; text-decoration: none;">
