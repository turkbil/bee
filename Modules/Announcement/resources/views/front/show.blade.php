...
<div class="animate-fade-in py-6">
    <article class="max-w-4xl mx-auto">
        <div class="p-8">
            ...
            <div class="flex flex-wrap items-center gap-3 text-sm text-gray-600 dark:text-gray-400 mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-6 pt-4 pb-4 border-t border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="flex items-center">
                    <a href="{{ $item->attachment }}" class="inline-flex items-center text-primary dark:text-primary-400 hover:underline font-medium" target="_blank">
            ...
            <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ route('announcements.index') }}" class="inline-flex items-center text-primary dark:text-primary-400 hover:underline font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
