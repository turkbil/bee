            ...
            'technical_specs' => json_encode(json_decode(<<<'JSON'
                {
                    ...
                    "Toplam Uzunluk (l1)": "3566 mm",
                    "Çatala Kadar Uzunluk (l2)": "2496 mm",
                    "Toplam Genişlik (b1/b2)": "1154 mm",
                    "Çatal Ölçüsü (s/e/l)": "45×122×1070 mm",
                    "Çatal Sınıfı": "ISO 2A",
                    "Çatal Taşıyıcı Genişliği (b3)": "1040 mm",
                    "Ön İz Genişliği": "975 mm",
                    "Arka İz Genişliği": "955 mm",
                    "Zemin Boşluğu (mast/orta)": "120 / 150 mm",
                    "Koridor Genişliği 1000×1200 (Ast)": "3898 mm",
                    "Koridor Genişliği 800×1200 (Ast)": "4098 mm",
                    "Dönüş Yarıçapı (Wa)": "2217 mm",
                    "Yürüyüş Hızı (yük/boş)": "11/12 km/s",
                    "Kaldırma Hızı (yük/boş)": "0.29/0.36 m/s",
...
JSON
            ...
            'features' => json_encode(json_decode(<<<'JSON'
                [
                    ...
                    {
                        "icon": "arrows-alt",
                        "text": "Kompakt şasi ve 2217 mm dönüş yarıçapı ile dar alan çevikliği"
                    },
                    {
                        "icon": "shield-alt",
