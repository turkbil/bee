...
class ShopCategoryComponent extends Component
{
    ...
    public function boot(ShopCategoryService $categoryService): void
    {
    ...
    public function mount(): void
    {
        ...
        $this->tabConfig = [
            ['name' => __('shop::admin.new_category'), 'icon' => 'fas fa-plus']
        ];
    ...
    public function categories()
    {
        ...
        $query = ShopCategory::withCount('products');
    ...
    public function addCategory(): void
    {
        ...
        try {
            ...
            $maxOrder = ShopCategory::max('sort_order') ?? -1;
    ...
    public function editCategory(int $categoryId): void
    {
        try {
            ...
            $this->dispatch('toast', [
                'title' => __('admin.success'),
                'message' => __('shop::admin.category_loaded_for_editing'),
                'type' => 'info',
            ]);
            ...
            $this->dispatch('toast', [
                'title' => __('admin.error'),
                'message' => __('shop::admin.category_load_failed'),
                'type' => 'error',
            ]);
        }
    }
    ...
    public function toggleCategoryStatus(int $categoryId): void
    {
        try {
            ...
            $this->dispatch('toast', [
                'title' => __('admin.error'),
                'message' => __('shop::admin.category_status_update_failed'),
                'type' => 'error',
            ]);
        }
    }
        ...
        try {
            ...
            foreach ($items as $item) {
                if (isset($item['id']) && isset($item['order'])) {
                    ...
                    ShopCategory::where('category_id', $item['id'])
                        ->update($updateData);
                }
            }
            ...
            $this->dispatch('toast', [
                'title' => __('admin.success'),
                'message' => __('shop::admin.category_order_updated'),
                'type' => 'success',
                'duration' => 3000
            ]);
    ...
    public function switchLanguage($language)
    {
        if (in_array($language, $this->availableLanguages)) {
            ...
            \Log::info('🎯 ShopCategoryComponent switchLanguage', [
    ...
    {
        return view('shop::admin.livewire.category-component', [
