...
class ES16_16WA_Istif_1_Master extends Seeder {
    public function run(): void {
        $categoryId = 3;
        $brandId = 1;
        $sku = 'ES16-16WA';
        $titleTr = 'İXTİF ES16-16WA - 1.6 Ton Elektrikli Yaya Tipi İstif Makinesi';

        DB::table('shop_products')->updateOrInsert(['sku' => $sku], [
            'sku' => $sku,
            'title' => json_encode(['tr' => $titleTr], JSON_UNESCAPED_UNICODE),
            'slug' => json_encode(['tr' => Str::slug($titleTr)], JSON_UNESCAPED_UNICODE),
            'short_description' => json_encode(['tr' => '1600 kg kapasite, 600 mm yük merkezi ve 5.0 / 5.5 km/s (yüklü/boş) seyir hızıyla dar koridorlarda çevik istifleme. 800 mm gövde genişliği, 1589 mm dönüş yarıçapı ve 24V 230Ah (210 kg) enerji sistemiyle gün boyu verimli operasyon; iki kademeli indirme hassasiyeti.'], JSON_UNESCAPED_UNICODE),
            'base_price' => 0.00,
            ...
            'technical_specs' => json_encode(json_decode(<<<'JSON'
                {
                    ...
                    "Kaldırma Hızı (yüklü/boş)": "0.13 / 0.16 m/s (yüklü/boş)",
                    "İndirme Hızı (yüklü/boş)": "0.22 / 0.13 m/s (yüklü/boş)",
                    "Tırmanma Kabiliyeti (yüklü/boş)": "8% / 16% (yüklü/boş)",
                    "Sürüş Motoru": "1.1 kW (S2 60 dk)",
                    "Kaldırma Motoru": "3.0 kW (S3 15%)",
                    "Akü": "24V 230Ah (210 kg)",
