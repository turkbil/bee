...
class FavoritePermissionTest extends TestCase
{
    ...
    public function admin_can_update_favorite(): void
    {
        ...
        $favorite->update(['title' => ['tr' => 'Updated Title', 'en' => 'Updated Title']]);

        $this->assertEquals('Updated Title', $favorite->fresh()->getTranslated('title', 'tr'));
    }

    /** @test */
    public function admin_can_delete_favorite(): void
    {
        $this->actingAs($this->admin);
    ...
    /** @test */
    public function viewer_can_view_favorites_but_cannot_edit(): void
    {
    ...
    public function xss_protection_is_active(): void
    {
        ...
        $this->assertStringNotContainsString('<script>', $favorite->fresh()->getTranslated('body', 'tr'));
    }
    ...
    public function sql_injection_protection_works(): void
    {
        ...
        $maliciousInput = "'; DROP TABLE favorites; --";
    ...
    public function mass_assignment_protection_works(): void
    {
        ...
        $favorite = Favorite::create([
            ...
            'body' => ['tr' => 'Test', 'en' => 'Test'],
            'is_active' => true,
            // favorite_id manuel set edilemez (primary key)
            'favorite_id' => 9999,
        ]);

        // favorite_id otomatik generate edilmeli, manuel değer ignore edilmeli
        $this->assertNotEquals(9999, $favorite->favorite_id);
    }
    ...
    {
        $routes = [
            route('admin.favorite.index'),
            route('admin.favorite.manage'),
        ];
