...
class EFXZ_251_Forklift_3_Variants extends Seeder {
    public function run(): void {
        ...
        if (!$m) {$this->command->error('❌ Master bulunamadı: EFXZ-251'); return; }
        ...
        $variants = [
            [
                ...
                'long_description' => '<section><h2>1070 mm: Standart Paletlerde Maksimum Çeviklik</h2><p>EFXZ 251\'in 1070 mm çatal konfigürasyonu, EUR ve ISO paletlerde denge ve çeviklik arasında kusursuz bir denge kurar. Kısa çıkıntı, dar koridorda daha iyi dönüş, rampa yaklaşımında ise kontrollü ağırlık transferi sağlar. 80V 150Ah Li-Ion enerji sistemi fırsat şarjı ile vardiya planlarını esnekleştirir; 11/12 km/s seyir ve 0.29/0.36 m/s kaldırma profiliyle akışı hızlandırır.</p></section><section><h3>Teknik Odak</h3><p>2500 kg kapasite (c=500 mm), 1595 mm dingil mesafesi ve 2316 mm dönüş yarıçapı, 3000 mm standart kaldırma ile birleştiğinde depo içi operasyonların omurgasını oluşturur. Pnömatik lastikler (7.00-12-12PR / 18×7-8-14PR) düzensiz zeminlerde sarsıntıyı azaltır; hidrolik hizmet freni ve mekanik park freni güvenli duruş sağlar.</p></section><section><h3>Sonuç</h3><p>Standart palet akışları için hızlı, güvenli ve ekonomik bir çözüm. 0216 755 3 555</p></section>',
                'use_cases' => [
