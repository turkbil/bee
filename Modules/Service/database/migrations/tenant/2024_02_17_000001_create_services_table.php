...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('services', function (Blueprint $table) {
            ...
            $table->index(['is_active', 'deleted_at', 'created_at'], 'services_active_deleted_created_idx');
            $table->index(['is_active', 'deleted_at'], 'services_active_deleted_idx');
        });
        ...
        if (DB::getDriverName() === 'mysql') {
            ...
            if ($supportsJsonIndex) {
                ...
                foreach ($systemLanguages as $locale) {
                    DB::statement("
                        CREATE INDEX services_slug_{$locale}_idx ON services (
