...
return [
    ...
    'routes' => [
        'index' => [
            'controller' => \Modules\Payment\App\Http\Controllers\Front\PaymentController::class,
            'method' => 'index'
        ],
        'show' => [
            'controller' => \Modules\Payment\App\Http\Controllers\Front\PaymentController::class,
    ...
    'form' => [
        'persistence' => [
            ...
            'storage_key' => 'payment_active_tab',
    ...
    'menu_url_types' => [
        [
            'type' => 'detail',
            'label' => 'payment::admin.payment_detail',
     ...
     */
    'pagination' => [
        'admin_per_payment' => env('PAYMENT_ADMIN_PER_PAGE', 10),
        'front_per_payment' => env('PAYMENT_FRONT_PER_PAGE', 12),
        'max_per_payment' => 100,
    ],
     ...
     */
    'features' => [
        'ai_translation' => env('PAYMENT_AI_TRANSLATION', true),
        'bulk_operations' => env('PAYMENT_BULK_OPERATIONS', true),
        'inline_editing' => env('PAYMENT_INLINE_EDITING', true),
        'version_control' => env('PAYMENT_VERSION_CONTROL', false),
        'preview_mode' => env('PAYMENT_PREVIEW_MODE', true),
        'custom_css_js' => false,
    ],
    ...
    'integrations' => [
        'studio' => [
            'enabled' => env('PAYMENT_STUDIO_ENABLED', true),
     ...
     */
    'queue' => [
        'connection' => env('PAYMENT_QUEUE_CONNECTION', 'redis'),
        'queue_name' => env('PAYMENT_QUEUE_NAME', 'tenant_isolated'),
        'retry_after' => 90,
        'tries' => 3,
    ...
    'cache' => [
        ...
        'tags' => ['payments', 'content'],
        'warming' => [
            'enabled' => env('PAYMENT_CACHE_WARMING_ENABLED', true),
    ...
    'security' => [
        ...
        // NOT: CSS/JS security ayarları yok çünkü Payment'ta custom CSS/JS desteği yok
    ],
    ...
    // ========================================
    'debug' => [
        'enabled' => env('PAYMENT_DEBUG_ENABLED', env('APP_DEBUG', false)),
        'verbose_logs' => env('PAYMENT_VERBOSE_LOGS', false),
        'log_channel' => env('PAYMENT_LOG_CHANNEL', 'stack'),
        'log_queries' => env('PAYMENT_LOG_QUERIES', false),
        'log_routes' => env('PAYMENT_LOG_ROUTES', false),
    ],
];
