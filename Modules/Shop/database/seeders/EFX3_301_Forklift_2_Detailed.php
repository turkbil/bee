            ...
            'highlighted_features' => json_encode(json_decode(<<<'JSON'
                [
                    ...
                    },
                    {
                        ...
                        "description": "Dar alanlarda 2250 mm dönüş ile akıcı yön değişimi"
                    },
                    {
                        "icon": "shield-alt",
