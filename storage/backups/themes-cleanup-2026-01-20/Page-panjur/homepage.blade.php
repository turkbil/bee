...
<body class="bg-gray-50 dark:bg-slate-900 text-gray-800 dark:text-gray-100 transition-colors duration-300"
            ...
            <div class="flex items-center justify-between py-4">
                ...
                <a href="{{ url('/') }}" class="flex items-center gap-3 group">
                    @if($siteLogo && $siteLogo !== 'Logo yok')
                        <img src="{{ cdn($siteLogo) }}" alt="{{ $siteName }}" class="h-10 w-auto">
                    @else
    ...
    <section class="relative min-h-[90vh] flex items-center overflow-hidden">
        {{-- Background Image Slider - Leonardo AI Generated --}}
        <div class="swiper hero-slider absolute inset-0 z-0">
            <div class="swiper-wrapper">
                {{-- Slide 1: Motorlu Panjur --}}
                <div class="swiper-slide">
                    <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ cdn('storage/tenant3/hero-slider/motorlu-panjur.jpg') }}');">
                        <div class="absolute inset-0 bg-gradient-to-r from-gray-900/90 via-gray-900/70 to-gray-900/50"></div>
                    </div>
                </div>
                {{-- Slide 2: Garaj Kapisi --}}
                <div class="swiper-slide">
                    <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ cdn('storage/tenant3/hero-slider/garaj-kapisi.jpg') }}');">
                        <div class="absolute inset-0 bg-gradient-to-r from-gray-900/90 via-gray-900/70 to-gray-900/50"></div>
                    </div>
                </div>
                {{-- Slide 3: Is Yeri Panjur --}}
                <div class="swiper-slide">
                    <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ cdn('storage/tenant3/hero-slider/is-yeri-panjur.jpg') }}');">
                        <div class="absolute inset-0 bg-gradient-to-r from-gray-900/90 via-gray-900/70 to-gray-900/50"></div>
                    </div>
                </div>
                {{-- Slide 4: Sineklik Sistemi --}}
                <div class="swiper-slide">
                    <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ cdn('storage/tenant3/hero-slider/sineklik-sistemi.jpg') }}');">
                        <div class="absolute inset-0 bg-gradient-to-r from-gray-900/90 via-gray-900/70 to-gray-900/50"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mx-auto px-3 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                {{-- Badge --}}
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-8" data-aos="fade-down">
                    <span class="w-2 h-2 bg-primary-500 rounded-full animate-pulse"></span>
                    <span class="text-primary-400 font-medium text-sm">{{ $siteSlogan }}</span>
                </div>
                ...
                <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-heading mb-6 leading-tight" data-aos="fade-up" data-aos-delay="100">
                    <span class="bg-gradient-to-r from-primary-400 to-primary-500 bg-clip-text text-transparent">Panjur Tamiri</span><br>
                    <span class="text-white">ve Montaj Hizmetleri</span>
                </h1>

                {{-- Subtitle --}}
                <p class="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed" data-aos="fade-up" data-aos-delay="200">
                    Istanbul'un tum bolgelerinde <strong class="text-white">7/24</strong> panjur tamiri, motorlu panjur sistemleri, sineklik ve garaj kapisi hizmetleri.
                </p>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <a href="#hizmetler" class="flex items-center gap-3 px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-semibold text-lg rounded-xl hover:bg-white/20 transition-all duration-300 border border-white/20 shadow-lg">
        ...
        <div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce z-10">
            <span class="text-white/50 text-xs uppercase tracking-widest">Kaydir</span>
            <i class="fat fa-chevron-down text-white/50"></i>
        </div>

        {{-- Slider Pagination --}}
        <div class="hero-pagination absolute bottom-20 left-1/2 -translate-x-1/2 z-10 flex gap-2"></div>
    </section>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            new Swiper('.hero-slider', {
                ...
                pagination: {
                    el: '.hero-pagination',
                    clickable: true,
                    bulletClass: 'w-3 h-3 rounded-full bg-white/30 cursor-pointer transition-all duration-300',
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-6">
                        @if($siteLogo && $siteLogo !== 'Logo yok')
                            <img src="{{ cdn($siteLogo) }}" alt="{{ $siteName }}" class="h-10 w-auto brightness-0 invert">
                        @else
