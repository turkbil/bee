...
$(document).ready(function() {
    ...
    setInterval(function() {
        if ($('.token-info-widget').length) {
            // Token widget varsa güncelle
            Livewire.emit('refreshTokenInfo');
        }
    }, 30000);
});
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-muted small">
                                    {{ ai_token_balance() ?? 0 }} {{ __('ai::admin.tokens') }}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="dropdown-item">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="text-muted small">
                                    {{ ai_monthly_usage() ?? 0 }} / {{ ai_monthly_limit() > 0 ? ai_monthly_limit() : __('ai::admin.unlimited') }}
                                </div>
                                @if(ai_monthly_limit() > 0)
                                <div class="progress progress-sm mt-1">
                                    <div class="progress-bar" style="width: {{ ai_usage_percentage() }}%"></div>
                                </div>
                                @endif
                            </div>
                        </div>
