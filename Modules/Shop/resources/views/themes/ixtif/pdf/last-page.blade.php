...
<body class="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white flex items-center justify-center p-8" style="width: 210mm; height: 297mm; margin: 0; padding: 2rem; overflow: hidden; background: linear-gradient(to bottom right, #0f172a, #1e3a8a, #0f172a) !important;">
    ...
    <div class="max-w-5xl w-full space-y-8">
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="bg-white/5 rounded-lg p-3 text-center">
                        ...
                        <div class="font-semibold text-sm">Sıfır Ürünler</div>
                    </div>
                    <div class="bg-white/5 rounded-lg p-3 text-center">
                        <div class="text-2xl mb-1">♻️</div>
                        <div class="font-semibold text-sm">İkinci El</div>
                    </div>
                    <div class="bg-white/5 rounded-lg p-3 text-center">
                        <div class="text-2xl mb-1">🔑</div>
                        <div class="font-semibold text-sm">Kiralama</div>
                    </div>
                    <div class="bg-white/5 rounded-lg p-3 text-center">
                        <div class="text-2xl mb-1">🔧</div>
                        <div class="font-semibold text-sm">Teknik Servis</div>
                    </div>
                    <div class="bg-white/5 rounded-lg p-3 text-center">
                        <div class="text-2xl mb-1">⚙️</div>
                        <div class="font-semibold text-sm">Yedek Parça</div>
                    </div>
                    <div class="bg-white/5 rounded-lg p-3 text-center">
                        <div class="text-2xl mb-1">🛡️</div>
                        <div class="font-semibold text-sm">Bakım</div>
                    </div>
                </div>
            </div>
        ...
        <!-- Footer -->
        <div class="text-center space-y-2 border-t border-white/10 pt-4">
