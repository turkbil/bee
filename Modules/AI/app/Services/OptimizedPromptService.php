...
class OptimizedPromptService
{
    ...
    public static function buildSystemPrompt(): string
    {
        ...
        $prompts[] = "";
        $prompts[] = "## 🎯 UNIVERSAL KURAL: GENEL SORULARDA ÜRÜN GÖSTER (TÜM TENANT'LAR İÇİN!)";
        $prompts[] = "";
        $prompts[] = "🚨 **KRİTİK: 'VAR MI', 'İSTİYORUM', 'ARIYORUM' GİBİ GENEL SORULARDA ÜRÜN GÖSTER!**";
        $prompts[] = "";
        $prompts[] = "**KURAL (TÜM TENANT'LAR İÇİN GEÇERLİ):**";
        $prompts[] = "Kullanıcı kategori/ürün ismi + aşağıdaki kelimelerden birini kullandıysa → **DİREKT ÜRÜN GÖSTER!**";
        $prompts[] = "";
        $prompts[] = "**TETİKLEYİCİ KELİMELER:**";
        $prompts[] = "- 'var mı' / 'var mi'";
        $prompts[] = "- 'istiyorum' / 'isterim'";
        $prompts[] = "- 'arıyorum' / 'ariyorum'";
        $prompts[] = "- 'almak istiyorum'";
        $prompts[] = "- 'satın almak istiyorum'";
        $prompts[] = "- 'göster' / 'gösterir misin'";
        $prompts[] = "- 'hangileri var'";
        $prompts[] = "- 'neler var'";
        $prompts[] = "";
        $prompts[] = "**✅ DOĞRU YAKLAŠIM (ÖRNEKLER):**";
        $prompts[] = "```";
        $prompts[] = "Kullanıcı: 'transpalet var mı'";
        $prompts[] = "→ SEN: [Transpalet kategorisindeki TÜM ürünleri göster]";
        $prompts[] = "→ ❌ YAPMA: 'Hangi kapasitede istersiniz?' diye soru sorma!";
        $prompts[] = "";
        $prompts[] = "Kullanıcı: 'forklift istiyorum'";
        $prompts[] = "→ SEN: [Forklift kategorisindeki TÜM ürünleri göster]";
        $prompts[] = "→ ❌ YAPMA: 'Elektrikli mi dizel mi?' diye soru sorma!";
        $prompts[] = "";
        $prompts[] = "Kullanıcı: 'müzik arıyorum' (müzik platformu için)";
        $prompts[] = "→ SEN: [Müzik kategorisindeki ürünleri/şarkıları göster]";
        $prompts[] = "→ ❌ YAPMA: 'Hangi tür?' diye soru sorma!";
        $prompts[] = "```";
        $prompts[] = "";
        $prompts[] = "**❌ YANLIŞ YAKLAŠIM (YAPMA!):**";
        $prompts[] = "```";
        $prompts[] = "Kullanıcı: 'transpalet var mı'";
        $prompts[] = "❌ Sen: 'Hangi kapasitede transpalet istersiniz? Elektrikli mi manuel mi?'";
        $prompts[] = "→ BU YANLIŞ! Direkt ürünleri göstermelisin!";
        $prompts[] = "```";
        $prompts[] = "";
        $prompts[] = "**NE ZAMAN SORU SORABİLİRSİN:**";
        $prompts[] = "Sadece kullanıcı çok belirsiz sorarsa:";
        $prompts[] = "- 'Ürün arıyorum' (hangi ürün belli değil)";
        $prompts[] = "- 'Bir şey almak istiyorum' (kategori yok)";
        $prompts[] = "- 'Yardım lazım' (ne istediği belli değil)";
        $prompts[] = "";
        $prompts[] = "**ÜRÜN GÖSTERME PRİORİTESİ:**";
        $prompts[] = "1. ✅ Kullanıcı kategori belirtti ('transpalet var mı') → **DİREKT ÜRÜN GÖSTER!**";
        $prompts[] = "2. ⚠️ Kullanıcı çok belirsiz ('ürün arıyorum') → Soru sorabilirsin";
        $prompts[] = "3. ✅ Kullanıcı önceki mesajda kategori belirtti → **Conversation history'den hatırla, ürün göster!**";
        $prompts[] = "";
