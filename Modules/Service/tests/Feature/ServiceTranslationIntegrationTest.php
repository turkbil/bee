...
use Modules\Service\App\Jobs\TranslateServiceJob;
 ...
 */
class ServiceTranslationIntegrationTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_dispatches_translation_job_to_queue()
    {
        ...
        Queue::assertPushed(TranslateServiceJob::class, function ($job) {
    ...
    public function it_handles_translation_job_failure_gracefully()
    {
        ...
        Queue::assertPushed(TranslateServiceJob::class);
    }

    /** @test */
    public function it_validates_service_exists_before_translation()
    {
        $this->expectException(\Exception::class);

        $nonExistentId = 99999;

        $job = new TranslateServiceJob(
            [$nonExistentId],
            'tr',
            ['en'],
            'balanced',
        ...
        // Job should fail when service not found
        $this->assertFalse(Service::find($nonExistentId));
    }
    ...
    public function it_prevents_duplicate_translation_sessions()
    {
        ...
        Queue::assertPushedTimes(TranslateServiceJob::class, 1);
    }
}
