...
<div x-data="{
    ...
    timeRemaining: 12,
    preferences: JSON.parse(localStorage.getItem('cookieConsent') || '{\"necessary\":true,\"functional\":false,\"analytics\":false,\"marketing\":false}'),
    showModal: false,
    ...
    loadTrackingScripts() {
        ...
        if (this.preferences.analytics) {
            // Google Analytics veya diğer analytics scriptleri buraya
            console.log('Analytics enabled');
        }

        // Marketing
        if (this.preferences.marketing) {
            // Meta Pixel, Google Ads vb. buraya
