...
class PaymentCategoryComponent extends Component
{
    ...
    private PaymentCategoryService $categoryService;
    ...
    public function boot(PaymentCategoryService $categoryService): void
    {
    ...
    public function mount(): void
    {
        ...
        $this->tabConfig = [
            ['name' => __('payment::admin.new_category'), 'icon' => 'fas fa-plus']
        ];
    ...
    public function categories()
    {
        ...
        $query = PaymentCategory::withCount('payments');
    ...
    public function addCategory(): void
    {
        ...
        try {
            ...
            $maxOrder = PaymentCategory::max('sort_order') ?? -1;
    ...
    {
        try {
            $category = PaymentCategory::findOrFail($categoryId);
            ...
            $this->dispatch('toast', [
                'title' => __('admin.success'),
                'message' => __('payment::admin.category_loaded_for_editing'),
                'type' => 'info',
            ]);
            ...
            $this->dispatch('toast', [
                'title' => __('admin.error'),
                'message' => __('payment::admin.category_load_failed'),
                'type' => 'error',
            ]);
        }
    }
    ...
    public function toggleCategoryStatus(int $categoryId): void
    {
        try {
            ...
            $this->dispatch('toast', [
                'title' => __('admin.error'),
                'message' => __('payment::admin.category_status_update_failed'),
                'type' => 'error',
            ]);
        }
    }
        ...
        try {
            ...
            foreach ($items as $item) {
                if (isset($item['id']) && isset($item['order'])) {
                    ...
                    PaymentCategory::where('category_id', $item['id'])
                        ->update($updateData);
                }
            }
            ...
            $this->dispatch('toast', [
                'title' => __('admin.success'),
                'message' => __('payment::admin.category_order_updated'),
                'type' => 'success',
                'duration' => 3000
            ]);
    ...
    public function switchLanguage($language)
    {
        if (in_array($language, $this->availableLanguages)) {
            ...
            \Log::info('🎯 PaymentCategoryComponent switchLanguage', [
    ...
    {
        return view('payment::admin.livewire.category-component', [
