...
@section('module_content')
    <div class="relative" x-data="reviewsystemsList()" x-init="init()">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-3xl">
                        <h1
                            ...
                            {{ $moduleTitle ?? __('reviewsystem::front.general.reviewsystems') }}
                        </h1>
                    ...
                    <div class="text-center py-20" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
                        <div x-show="show" x-transition:enter="transition ease-out duration-500"
                            ...
                            <p class="text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
                                {{ __('reviewsystem::front.general.no_reviewsystems_found') }}</p>
                        </div>
                    </div>
                @endif
            </div>
