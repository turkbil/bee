                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 80px" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="{{ __('announcement::admin.status') }}">
                                <button
                                ...
                                <td class="sort-id small">
                                    <div class="hover-toggle">
                                        ...
                                        <input type="checkbox"
                                               ...
                                               id="checkbox-{{ $announcement->announcement_id }}"
                                               @checked(in_array($announcement->announcement_id, $selectedItems))>
                                    </div>
                                </td>
                                <td wire:key="title-{{ $announcement->announcement_id }}" class="position-relative">
                                    ...
                                    @else
                                        <div class="d-flex align-items-center">
                                            <span
                                                class="editable-title pr-4">{{ $announcement->getTranslated('title', $currentSiteLocale) ?? $announcement->getTranslated('title', 'tr') }}</span>
                                            <button class="btn btn-sm px-2 py-1 edit-icon ms-4"
                                                wire:click="startEditingTitle({{ $announcement->announcement_id }}, '{{ addslashes($announcement->getTranslated('title', $currentSiteLocale) ?? $announcement->getTranslated('title', 'tr')) }}')">
                                ...
                                <td class="text-center align-middle">
                                    <button wire:click="toggleActive({{ $announcement->announcement_id }})"
                                        ...
                                        <div wire:loading.remove
                                            wire:target="toggleActive({{ $announcement->announcement_id }})">
