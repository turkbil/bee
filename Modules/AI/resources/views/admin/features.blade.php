...
@section('title', 'AI Özellikleri ve Yetenekleri')
...
@section('content')
    ...
    <div class="row mb-4">
        <div class="col-auto">
            <span class="badge badge-success">{{ count(collect($features['active'])->flatten(1)) }} Aktif Özellik</span>
        </div>
        <div class="col-auto">
            <span class="badge badge-warning">{{ count(collect($features['potential'])->flatten(1)) }} Planlanan</span>
        </div>
    </div>
