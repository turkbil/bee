...
@php
    ...
    \Log::info('🔥 edit.blade.php view rendering', ['step' => $initialStep ?? 'unknown']);
@endphp

@section('title', 'AI Profil Düzenle')
...
/* Normal container davranışı korunur */
...
$(document).ready(function() {
    ...
    $('#complete-btn').click(function() {
        // Hemen show sayfasına yönlendir - hikaye oluşturmayı bekleme
        window.location.href = '{{ route("admin.ai.profile.show") }}?completed=1';
    });

    function goToStep(step) {
        // URL'yi güncelle
        let url = '{{ route("admin.ai.profile.edit", ":step") }}'.replace(':step', step);
