        ...
        <div class="announcement-item group overflow-hidden hover:shadow-sm transition-shadow duration-300">
            <div class="p-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">
                    <a href="{{ url('announcement', 'show_slug', [$item->slug]) }}" class="hover:text-primary dark:hover:text-primary-400 transition-colors duration-300">{{ $item->title }}</a>
                </h3>
                ...
                <div class="mt-4">
                    <a href="{{ url('announcement', 'show_slug', [$item->slug]) }}" class="inline-flex items-center text-sm text-primary dark:text-primary-400 hover:underline font-medium">
                        Devamını Oku
