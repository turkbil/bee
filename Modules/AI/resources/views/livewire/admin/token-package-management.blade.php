                                                ...
                                                @if($package->features && count($package->features) > 0)
                                                    <div class="mt-1">
                                                        ...
                                                        @if(count($package->features) > 2)
                                                            <span class="badge bg-secondary">+{{ count($package->features) - 2 }} özellik</span>
                                                        @endif
                                                    </div>
                                                @endif
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(count($features) > 0)
                                                ...
                                                <small class="text-muted">{{ count($features) }}/10 özellik eklendi</small>
                                            @endif
                                        </div>
                                    </div>
                                </div>
