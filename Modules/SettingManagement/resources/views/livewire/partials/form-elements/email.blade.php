...
@if($settingId)
    <div class="mb-3">
        <label class="form-label">{{ $element['properties']['label'] ?? 'E-posta' }}</label>
        <div class="input-icon">
            ...
            <input 
                ...
                class="form-control" 
                placeholder="{{ $element['properties']['placeholder'] ?? 'E-posta adresini girin' }}"
            >
        </div>
...
@else
    <div class="alert alert-danger">
        ...
        Bu e-posta alanı için ayar bulunamadı: {{ $element['properties']['name'] ?? 'Bilinmeyen' }}
    </div>
@endif