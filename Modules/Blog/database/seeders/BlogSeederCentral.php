...
class BlogSeederCentral extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (tenancy()->initialized) {
            $this->command->warn("⚠️  BlogSeederCentral sadece central database'de çalışır. Atlanıyor...");
            return;
        }

        // Blog tablosu central database'de yoksa atla
        if (!Schema::hasTable('blogs')) {
            $this->command->warn("⚠️  Blog tablosu central database'de yok. Atlanıyor...");
            return;
        }
