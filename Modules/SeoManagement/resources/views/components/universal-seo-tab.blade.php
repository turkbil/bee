            ...
            <div class="col-md-6 mb-3">
                <div class="form-floating" style="position: relative;">
                    <input type="text" 
                           ...
                           maxlength="60"
                           placeholder="{{ __('seomanagement::admin.seo_title') }}"
                           {{ $disabled ? 'disabled' : '' }}>
                    <label>
                        {{ __('seomanagement::admin.seo_title') }}
                    </label>
                    ...
                    <div class="form-text">
                        <small class="text-muted"><i class="fas fa-info-circle me-1"></i>{{ __('seomanagement::admin.seo_title_help') }}</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="form-floating" style="position: relative;">
                    <textarea class="form-control"
                              ...
                              rows="3"
                              style="height: 80px;"
                              placeholder="{{ __('seomanagement::admin.seo_description') }}"
                              {{ $disabled ? 'disabled' : '' }}></textarea>
                    <label>
                        {{ __('seomanagement::admin.seo_description') }}
                    </label>
                    <div style="position: absolute; right: 10px; top: 8px; z-index: 10;">
                        <small class="me-2" style="font-size: 0.7rem; font-weight: 300;">
                    ...
                    <div class="form-text">
                        <small class="text-muted"><i class="fas fa-info-circle me-1"></i>{{ __('seomanagement::admin.seo_description_help') }}</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="form-floating">
                    <input type="text" 
                           ...
                           placeholder="{{ __('seomanagement::admin.keywords_placeholder') }}"
                           {{ $disabled ? 'disabled' : '' }}>
                    <label>
                        {{ __('seomanagement::admin.seo_keywords') }}
                        <small class="text-muted">{{ __('seomanagement::admin.keywords_separator_note') }}</small>
                    </label>
                    <div class="form-text">
                        <small class="text-muted"><i class="fas fa-info-circle me-1"></i>{{ __('seomanagement::admin.seo_keywords_help') }}</small>
                    </div>
                </div>
            </div>
        </div>
