                            ...
                            <tr class="hover-trigger" wire:key="row-{{ $genre->genre_id }}">
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-flex align-items-center gap-3 justify-content-center">
                                        <a href="{{ route('admin.genre.manage', $genre->genre_id) }}"
                                        ...
                                        <a href="{{ route('admin.studio.editor', ['module' => 'genre', 'id' => $genre->genre_id]) }}"
                                            target="_blank" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="{{ __('muzibu::admin.genre.studio.editor') }}"
                                            style="min-height: 24px; display: inline-flex; align-items: center; text-decoration: none;">
