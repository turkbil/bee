...
readonly class PortfolioRepository implements PortfolioRepositoryInterface
{
    ...
    public function __construct(
        ...
        $this->cachePrefix = TenantCacheService::PREFIX_PORTFOLIO;
    ...
    public function findByIdWithSeo(int $id): ?Portfolio
    {
        ...
        if ($strategy === CacheStrategy::ADMIN_FRESH) {
            return $this->model->with('seoSetting')->where('portfolio_id', $id)->first();
        }
    ...
    public function getActive(): Collection
    {
        ...
        $cacheKey = $this->getCacheKey('active_portfolios');
    ...
    public function toggleActive(int $id): bool
    {
        ...
        $portfolio = $this->model->where('portfolio_id', $id)->first(['portfolio_id', 'is_active']);
    ...
    public function bulkToggleActive(array $ids): int
    {
        ...
        $portfolios = $this->model->whereIn('portfolio_id', $ids)->get(['portfolio_id', 'is_active']);
        $count = 0;
