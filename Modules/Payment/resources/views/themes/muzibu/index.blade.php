...
@section('module_content')
    <div class="relative" x-data="paymentsList()" x-init="init()">
                        ...
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-3">
                                    {{ $moduleTitle ?? __('payment::front.general.payments') }}
                                </h1>
                                <!-- Breadcrumb -->
                                <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                                    ...
                                    <span class="font-semibold text-gray-900 dark:text-white">{{ $moduleTitle ?? __('payment::front.general.payments') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center py-20" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
                        <div x-show="show" x-transition:enter="transition ease-out duration-500"
                            ...
                            <p class="text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
                                {{ __('payment::front.general.no_payments_found') }}</p>
                        </div>
                    </div>
                @endif
            </div>
