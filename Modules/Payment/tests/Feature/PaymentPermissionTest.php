...
class PaymentPermissionTest extends TestCase
{
    ...
    public function admin_can_update_payment(): void
    {
        ...
        $payment->update(['title' => ['tr' => 'Updated Title', 'en' => 'Updated Title']]);

        $this->assertEquals('Updated Title', $payment->fresh()->getTranslated('title', 'tr'));
    }
    ...
    /** @test */
    public function guest_cannot_access_admin_payments(): void
    {
        $response = $this->get(route('admin.payment.index'));
    ...
    /** @test */
    public function viewer_can_view_payments_but_cannot_edit(): void
    {
    ...
    public function xss_protection_is_active(): void
    {
        ...
        $this->assertStringNotContainsString('<script>', $payment->fresh()->getTranslated('body', 'tr'));
    }
    ...
    public function mass_assignment_protection_works(): void
    {
        ...
        $payment = Payment::create([
            ...
            'body' => ['tr' => 'Test', 'en' => 'Test'],
            'is_active' => true,
            // payment_id manuel set edilemez (primary key)
            'payment_id' => 9999,
        ]);

        // payment_id otomatik generate edilmeli, manuel değer ignore edilmeli
        $this->assertNotEquals(9999, $payment->payment_id);
    }
