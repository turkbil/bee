...
<div class="container animate-fade-in">
    <h1 class="text-3xl font-bold mb-6 text-center text-gray-800 dark:text-white">{{ $title ?? __('announcement::general.announcements') }}</h1>
        ...
        <div class="announcement-item group overflow-hidden hover:shadow-sm transition-shadow duration-300">
            <div class="p-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">
                    <a href="{{ href('Announcement', 'show', $item->slug) }}" class="hover:text-primary dark:hover:text-primary-400 transition-colors duration-300">{{ $item->title }}</a>
                </h3>
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm text-gray-600 dark:text-gray-400 mb-4">
                    <span class="flex items-center">
                        ...
                        {{ $item->created_at->format(__('announcement::general.date_format')) }}
                    </span>
                    ...
                    <span class="flex items-center">
                        ...
                        <span class="text-xs">{{ __('announcement::general.attachment') }}</span>
                    </span>
                    @endif
                </div>
                ...
                <div class="mt-4">
                    <a href="{{ href('Announcement', 'show', $item->slug) }}" class="inline-flex items-center text-sm text-primary dark:text-primary-400 hover:underline font-medium">
                        {{ __('announcement::general.continue_reading') }}
    ...
    <div class="border-t-4 border-primary dark:border-primary-400 p-8 text-center">
        ...
        <p class="mt-4 text-xl">{{ __('announcement::general.no_announcements_yet') }}</p>
    </div>
    @endif
</div>
@endsection