...
class AlbumComponent extends Component
{
    ...
    public function boot(AlbumService $albumService): void
    {
    ...
    public function refreshPageData()
    {
        ...
        $this->albumService->clearCache();
        $this->render();
    }

    public function handleTranslationCompleted($eventData)
    {
        Log::info('🎉 MUZIBU: AlbumComponent - TranslationCompleted event received', $eventData);

        $this->dispatch('translation-complete', [
            'success' => true,
            'sessionId' => $eventData['sessionId'] ?? null,
            'entityType' => $eventData['entityType'] ?? 'album',
    ...
    {
        return \Modules\Muzibu\App\Models\Album::class;
    }
    ...
    {
        try {
            $result = $this->albumService->toggleAlbumStatus($id);
    ...
    public function render(): \Illuminate\Contracts\View\View
    {
        ...
        return view('muzibu::admin.livewire.album-component', [
            'albums' => $albums,
