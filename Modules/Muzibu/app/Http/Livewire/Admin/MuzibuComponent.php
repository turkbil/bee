...
#[Layout('admin.layout')]
class MuzibuComponent extends Component
{
    ...
    private MuzibuService $muzibuService;

    public function boot(MuzibuService $muzibuService): void
    {
        $this->muzibuService = $muzibuService;
    ...
    {
        \Log::info('🎉 NURU: MuzibuComponent - TranslationCompleted event received', $eventData);

        // Frontend'e completion event'ini dispatch et
        $this->dispatch('translation-complete', [
            'success' => true,
            'sessionId' => $eventData['sessionId'] ?? null,
            'entityType' => $eventData['entityType'] ?? 'muzibu',
    ...
    {
        return \Modules\Muzibu\App\Models\Muzibu::class;
    }
    ...
    {
        try {
            $result = $this->muzibuService->toggleMuzibuStatus($id);
    ...
    public function render(): \Illuminate\Contracts\View\View
    {
        ...
        $muzibus = $this->muzibuService->getPaginatedMuzibus($filters, (int) $this->perPage);

        return view('muzibu::admin.livewire.muzibu-component', [
            'muzibus' => $muzibus,
    ...
    public function translateFromModal(array $data): array
    {
        try {
            ...
            // TranslateMuzibuJob kullanarak async çeviri başlat
            $muzibuId = $data['entityId'] ?? null;
            if (!$muzibuId) {
                throw new \Exception('Muzibu ID bulunamadı');
            }
            ...
            // Job'u kuyruğa ekle
            Log::info('📦 TranslateMuzibuJob kuyruğa ekleniyor', [
                'muzibu_id' => $muzibuId,
            ...
            $job = \Modules\Muzibu\App\Jobs\TranslateMuzibuJob::dispatch(
                [$muzibuId], // Array olarak gönder
            ...
            Log::info('✅ TranslateMuzibuJob başarıyla kuyruğa eklendi', [
