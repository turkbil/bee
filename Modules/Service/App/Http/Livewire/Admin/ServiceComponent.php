...
use Modules\Service\App\Http\Livewire\Traits\{InlineEditTitle, WithBulkActions};
use Modules\Service\App\Services\ServiceService;
use Modules\LanguageManagement\App\Models\TenantLanguage;
use Modules\Service\App\DataTransferObjects\ServiceOperationResult;
...
class ServiceComponent extends Component
{
    ...
    public function boot(ServiceService $serviceService): void
    {
    ...
    {
        \Log::info('🎉 NURU: ServiceComponent - TranslationCompleted event received', $eventData);

        // Frontend'e completion event'ini dispatch et
        $this->dispatch('translation-complete', [
            'success' => true,
            'sessionId' => $eventData['sessionId'] ?? null,
            'entityType' => $eventData['entityType'] ?? 'service',
    ...
    {
        return \Modules\Service\App\Models\Service::class;
    }
    ...
    {
        try {
            $result = $this->serviceService->toggleServiceStatus($id);
    ...
    public function render(): \Illuminate\Contracts\View\View
    {
        ...
        $services = $this->serviceService->getPaginatedServices($filters, (int) $this->perPage);

        return view('service::admin.livewire.service-component', [
            'services' => $services,
    ...
    public function translateFromModal(array $data): array
    {
        try {
            ...
            // TranslateServiceJob kullanarak async çeviri başlat
            $serviceId = $data['entityId'] ?? null;
            if (!$serviceId) {
                throw new \Exception('Service ID bulunamadı');
            }
            ...
            // Job'u kuyruğa ekle
            Log::info('📦 TranslateServiceJob kuyruğa ekleniyor', [
            ...
            $job = \Modules\Service\App\Jobs\TranslateServiceJob::dispatch(
                [$serviceId], // Array olarak gönder
            ...
            Log::info('✅ TranslateServiceJob başarıyla kuyruğa eklendi', [
