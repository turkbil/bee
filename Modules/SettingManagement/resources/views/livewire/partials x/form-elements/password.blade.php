            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h3 class="card-title d-flex align-items-center">
                        ...
                        {{ $element['properties']['label'] ?? __('settingmanagement::general.password_field_default') }}
                    </h3>
                </div>
            </div>
            <div class="card-body">
                <div class="form-group w-100">
                    <div class="input-icon w-100">
                        ...
                        <input 
                            ...
                            placeholder="{{ $element['properties']['placeholder'] ?? __('settingmanagement::general.password_field_placeholder') }}"
                        >
                    </div>
...
@else
    <div class="col-12">
        <div class="alert alert-danger mb-3 w-100">
            ...
            {{ __('settingmanagement::general.password_setting_not_found') }} {{ $element['properties']['name'] ?? 'Bilinmeyen' }}
        </div>
    </div>
@endif