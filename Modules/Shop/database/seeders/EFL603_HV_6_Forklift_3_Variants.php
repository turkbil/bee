...
class EFL603_HV_6_Forklift_3_Variants extends Seeder {
    public function run(): void {
        ...
        if (!$m) {$this->command->error('❌ Master bulunamadı: EFL603-HV-6'); return; }
        $variants = [
            [
