...
@section('module_content')
    @php
        ...
        $reviewsystemIndexUrl = $localePrefix . '/' . $indexSlug;
        ...
        $breadcrumbsArray = [
            ...
            ['label' => __('reviewsystem::front.general.reviewsystems'), 'url' => url($reviewsystemIndexUrl)],
            ['label' => $title]
        ];
    @endphp
                    ...
                    <aside class="lg:col-span-2">
                        <div class="sticky top-24 space-y-6">
                            ...
                            <figure class="rounded-2xl overflow-hidden shadow-2xl">
                                <a href="{{ $featuredImage->getUrl() }}" class="glightbox block" data-gallery="reviewsystem-main">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                    @foreach($galleryImages as $image)
                        <a href="{{ $image->getUrl() }}"
                           ...
                           data-gallery="reviewsystem-gallery">
