            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h3 class="card-title d-flex align-items-center">
                        ...
                        {{ $element['properties']['label'] ?? t('settingmanagement::general.text_field_default') }}
                    </h3>
                </div>
            </div>
            <div class="card-body">
                <div class="form-group w-100">
                    <div class="input-icon w-100">
                        ...
                        <input 
                            ...
                            placeholder="{{ $element['properties']['placeholder'] ?? t('settingmanagement::general.text_field_placeholder') }}"
                        >
                    </div>
