    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="portfolio-item overflow-hidden hover:shadow-sm transition-shadow duration-300">
            <div class="relative overflow-hidden aspect-w-16 aspect-h-9">
                <a href="{{ href('portfolio', 'show_slug', [$item->slug]) }}">
            ...
            <div class="p-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">
                    <a href="{{ href('portfolio', 'show_slug', [$item->slug]) }}" class="hover:text-primary dark:hover:text-primary-400 transition-colors duration-300">{{ $item->title }}</a>
                </h3>
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    <span class="flex items-center">
                        ...
                        <a href="{{ href('portfolio', 'category_slug', [$item->category->slug]) }}" class="hover:text-primary dark:hover:text-primary-400">
                            {{ $item->category->title }}
                        </a>
                    </span>
                    @endif
                ...
                <div class="mt-4">
                    <a href="{{ href('portfolio', 'show_slug', [$item->slug]) }}" class="inline-flex items-center text-sm text-primary dark:text-primary-400 hover:underline font-medium">
                        Detayları Gör
