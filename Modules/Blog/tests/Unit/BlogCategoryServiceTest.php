...
/**
 * BlogCategoryService Unit Tests
 */
class BlogCategoryServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repositoryMock = Mockery::mock(BlogCategoryRepository::class);
        $this->service = new BlogCategoryService($this->repositoryMock);
    }
    ...
    {
        $category = BlogCategory::factory()->make(['category_id' => 1]);
    ...
    {
        $categories = collect([
            BlogCategory::factory()->make(['is_active' => true]),
            BlogCategory::factory()->make(['is_active' => true]),
        ]);
    ...
    /** @test */
    public function it_deletes_category_without_blogs(): void
    {
        Log::shouldReceive('info')->once();

        $category = BlogCategory::factory()->make(['category_id' => 1]);
        $category->shouldReceive('blogs')->andReturnSelf();
