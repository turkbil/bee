@php
    ...
    $placeholder = isset($element['properties']['placeholder']) ? $element['properties']['placeholder'] : __('settingmanagement::general.select_field_placeholder');
        ...
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between">
                <h3 class="card-title d-flex align-items-center">
                    ...
                    {{ $element['properties']['label'] ?? __('settingmanagement::general.select_field_default') }}
                </h3>
            </div>
        </div>
        <div class="card-body">
