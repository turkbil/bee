<div>
    @php
        View::share(
            'pretitle',
            $muzibuId ? __('muzibu::admin.edit_muzibu_pretitle') : __('muzibu::admin.new_muzibu_pretitle'),
        );
    @endphp
    ...
    <form method="post" wire:submit.prevent="save">
        ...
        <div class="card">
            ...
            <x-tab-system :tabs="$tabConfig" :tab-completion="$tabCompletionStatus" storage-key="muzibu_active_tab">
                {{-- Studio Edit Button --}}
                @if ($studioEnabled && $muzibuId)
                    <li class="nav-item ms-3">
                        <a href="{{ route('admin.studio.editor', ['module' => 'muzibu', 'id' => $muzibuId]) }}"
                            target="_blank" class="btn btn-outline-primary"
                            style="padding: 0.20rem 0.75rem; margin-top: 5px;">
                            <i
                                class="fa-solid fa-wand-magic-sparkles fa-lg me-1"></i>{{ __('muzibu::admin.studio.editor') }}
                        </a>
                    </li>
                @endif
            ...
            <div class="card-body">
                <div class="tab-content" id="contentTabContent">
                    ...
                    <div class="tab-pane show active" id="0" role="tabpanel">
                        @foreach ($availableLanguages as $lang)
                            ...
                            <div class="language-content" data-language="{{ $lang }}"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input type="text" wire:model="multiLangInputs.{{ $lang }}.title"
                                                ...
                                                placeholder="{{ __('muzibu::admin.title_field') }}">
                                            <label>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12 col-md-6">
                                        <div class="form-floating">
                                            <select wire:model="inputs.muzibu_category_id"
                                                class="form-control @error('inputs.muzibu_category_id') is-invalid @enderror"
                                                id="category_select">
                                                <option value="">{{ __('muzibu::admin.select_category') }}</option>
                                            ...
                                            <label for="category_select">
                                                {{ __('muzibu::admin.category') }}
                                            </label>
                                            @error('inputs.muzibu_category_id')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                        ...
                        <div class="mb-4">
                            <livewire:mediamanagement::universal-media
                                wire:id="muzibu-media-component"
                                :model-id="$muzibuId"
                                model-type="muzibu"
                        ...
                        @foreach ($availableLanguages as $lang)
                            ...
                            <div class="language-content" data-language="{{ $lang }}"
                                ...
                                @include('admin.components.content-editor', [
                                    ...
                                    'langData' => $langData,
                                    'fieldName' => 'body',
                                    'label' => __('muzibu::admin.content'),
                                    'placeholder' => __('muzibu::admin.content_placeholder'),
                                ])
                            </div>
                        @endforeach
                        ...
                        <div class="mb-3 mt-4">
                            <div class="pretty p-default p-curve p-toggle p-smooth ms-1">
                                ...
                                <div class="state p-success p-on ms-2">
                                    <label>{{ __('muzibu::admin.active') }}</label>
                                </div>
                                <div class="state p-danger p-off ms-2">
                                    <label>{{ __('muzibu::admin.inactive') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane" id="1" role="tabpanel">
                        <livewire:seomanagement::universal-seo-tab :model-id="$muzibuId" model-type="muzibu"
                            model-class="Modules\Muzibu\App\Models\Muzibu" />
                    </div>
            ...
            <x-form-footer route="admin.muzibu" :model-id="$muzibuId" />
    ...
    @push('scripts')
        {{-- 🎯 MODEL & MODULE SETUP --}}
        <script>
            window.currentModelId = {{ $muzibuId ?? 'null' }};
            window.currentModuleName = 'muzibu';
