                    ...
                    for (let i = 0; i < slideCount; i++) {
                        content += `
                            <div class="carousel-item ${i === 0 ? 'active' : ''}">
                                <img src="https://via.placeholder.com/800x400?text=Slide+${i+1}" 
        ...
        blockManager.add('gallery', {
            ...
            content: `
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        <img src="https://via.placeholder.com/400x300?text=1" class="img-fluid rounded" alt="Görsel 1">
                    </div>
                    <div class="col-md-4">
                        <img src="https://via.placeholder.com/400x300?text=2" class="img-fluid rounded" alt="Görsel 2">
                    </div>
                    <div class="col-md-4">
                        <img src="https://via.placeholder.com/400x300?text=3" class="img-fluid rounded" alt="Görsel 3">
                    </div>
                    <div class="col-md-4">
                        <img src="https://via.placeholder.com/400x300?text=4" class="img-fluid rounded" alt="Görsel 4">
                    </div>
                    <div class="col-md-4">
                        <img src="https://via.placeholder.com/400x300?text=5" class="img-fluid rounded" alt="Görsel 5">
                    </div>
                    <div class="col-md-4">
                        <img src="https://via.placeholder.com/400x300?text=6" class="img-fluid rounded" alt="Görsel 6">
                    </div>
                </div>
            `
        });
