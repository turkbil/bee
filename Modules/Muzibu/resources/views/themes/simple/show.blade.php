...
@section('module_content')
    <div class="min-h-screen">
        @php
            ...
            $indexSlug = $moduleSlugService->getMultiLangSlug('Muzibu', 'index', $currentLocale);
            $defaultLocale = get_tenant_default_locale();
            $localePrefix = $currentLocale !== $defaultLocale ? '/' . $currentLocale : '';
            $muzibuIndexUrl = $localePrefix . '/' . $indexSlug;
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            ...
            <footer class="mt-16 md:mt-20 pt-8 border-t-2 border-gray-200 dark:border-gray-700">
                <a href="{{ $muzibuIndexUrl }}"
                    ...
                    <span>{{ __('muzibu::front.general.all_muzibus') }}</span>
                </a>
            </footer>
        </div>
    </div>
