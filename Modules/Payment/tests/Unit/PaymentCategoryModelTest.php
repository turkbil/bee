...
class PaymentCategoryModelTest extends TestCase
{
    ...
    public function active_scope_returns_only_active_categories(): void
    {
        ...
        $activeCategories = PaymentCategory::active()->get();
    ...
    /** @test */
    public function it_has_payments_relationship(): void
    {
        $category = PaymentCategory::factory()->create();

        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Relations\HasMany::class, $category->payments());
    }
    ...
    public function it_can_have_parent_category(): void
    {
        ...
        $child = PaymentCategory::factory()->create(['parent_id' => $parent->category_id]);
    ...
    {
        $parent = PaymentCategory::factory()->create();
        $child1 = PaymentCategory::factory()->create(['parent_id' => $parent->category_id]);
        $child2 = PaymentCategory::factory()->create(['parent_id' => $parent->category_id]);
    ...
    {
        $parent = PaymentCategory::factory()->create(['parent_id' => null]);
        $child = PaymentCategory::factory()->create(['parent_id' => $parent->category_id]);
        $grandchild = PaymentCategory::factory()->create(['parent_id' => $child->category_id]);
    ...
    public function it_has_factory(): void
    {
        ...
        $this->assertInstanceOf(PaymentCategory::class, $category);
        $this->assertDatabaseHas('payment_categories', ['category_id' => $category->category_id]);
    }
    ...
    {
        $category = PaymentCategory::factory()->inactive()->create();
    ...
    public function it_prevents_circular_reference_in_depth_calculation(): void
    {
        ...
        $category = PaymentCategory::factory()->create(['parent_id' => null]);
