...
class PlaylistComponent extends Component
{
    ...
    {
        Log::info('🎉 MUZIBU: PlaylistComponent - TranslationCompleted event received', $eventData);

        $this->dispatch('translation-complete', [
            'success' => true,
            'sessionId' => $eventData['sessionId'] ?? null,
            'entityType' => $eventData['entityType'] ?? 'playlist',
    ...
    {
        return \Modules\Muzibu\App\Models\Playlist::class;
    }
    ...
    {
        try {
            $result = $this->playlistService->togglePlaylistStatus($id);
    ...
    public function render(): \Illuminate\Contracts\View\View
    {
        ...
        return view('muzibu::admin.livewire.playlist-component', [
            'playlists' => $playlists,
