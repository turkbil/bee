    ...
    <div class="mb-4 sm:mb-6 flex items-center justify-between">
        <div class="flex items-center gap-3 sm:gap-4">
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm sm:text-base">Oluşturduğun tüm playlistler</p>
            </div>
        </div>

        {{-- Create Playlist Button --}}
        <button @click="$dispatch('open-create-playlist-modal')"
                class="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-muzibu-coral hover:bg-muzibu-coral/90 text-white text-sm sm:text-base font-semibold rounded-full transition-all transform hover:scale-105">
