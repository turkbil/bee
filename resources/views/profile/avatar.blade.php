<x-app-layout>
    <x-slot name="header">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-2">
            <i class="fa-solid fa-camera text-purple-600 dark:text-purple-400 mr-2"></i>
            Avatar Yönetimi
        </h1>
    </x-slot>
        ...
        <div class="lg:col-span-3">
            ...
            <div x-data="avatarManager()" class="profile-card bg-white dark:bg-gray-800 rounded-xl p-6">
                ...
                <div class="flex items-center mb-6">
                    <div class="p-3 bg-purple-100 dark:bg-purple-900/50 rounded-xl mr-4">
                        <i class="fa-solid fa-image text-2xl text-purple-600 dark:text-purple-400"></i>
                    </div>
                    <div>
