    ...
    <form wire:submit.prevent="save">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ t('thememanagement::general.theme_information') }}</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <!-- Temel Bilgiler -->
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            ...
                            <label>{{ t('thememanagement::general.theme_code') }}</label>
                            @error('inputs.name')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-hint">{{ t('thememanagement::general.theme_code_hint') }}</small>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label>{{ t('thememanagement::general.theme_title') }}</label>
                            @error('inputs.title')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="form-hint">{{ t('thememanagement::general.theme_title_hint') }}</small>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-6">
                                <div class="pretty p-default p-curve p-toggle p-smooth">
                                    ...
                                    <div class="state p-success p-on ms-2">
                                        <label>{{ t('thememanagement::general.active') }}</label>
                                    </div>
                                    <div class="state p-danger p-off ms-2">
                                        <label>{{ t('thememanagement::general.not_active') }}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="pretty p-default p-curve p-toggle p-smooth">
                                    ...
                                    <div class="state p-success p-on ms-2">
                                        <label>{{ t('thememanagement::general.default_theme') }}</label>
                                    </div>
                                    <div class="state p-danger p-off ms-2">
                                        <label>{{ t('thememanagement::general.not_default') }}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Tema Görseli -->
                        <div class="mb-4">
                            <h4 class="form-label">{{ t('thememanagement::general.theme_preview_image') }}</h4>
                            @include('thememanagement::livewire.partials.image-upload', [
                                'imageKey' => 'thumbnail',
                                'label' => t('thememanagement::general.drop_or_click_image')
                            ])
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            <textarea wire:model="inputs.description" class="form-control" data-bs-toggle="autosize" rows="5" 
                                placeholder="{{ t('thememanagement::general.theme_description_placeholder') }}"></textarea>
                            <label>{{ t('thememanagement::general.theme_description') }}</label>
                        </div>
                    </div>
                </div>
            </div>
