...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Kaydedilmiş durumları yükle (localStorage)
    if (window.loadSavedStates) {
      setTimeout(() => {
    ...
    deviceBtns.forEach(btn => {
      btn.addEventListener("click", function() {
        ...
        if (deviceType === "desktop") {
          window.formCanvas.style.maxWidth = "100%";
        } else if (deviceType === "tablet") {
          window.formCanvas.style.maxWidth = "768px";
        } else if (deviceType === "mobile") {
          window.formCanvas.style.maxWidth = "375px";
        }
      });
    });
