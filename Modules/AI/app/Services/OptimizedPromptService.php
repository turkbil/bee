...
class OptimizedPromptService
{
    ...
    protected static function buildConversationFlowGuidance(): string
    {
        ...
        $prompts[] = "2. MUTLAKA detay iste (2-3 soru):";
        $prompts[] = "   - Kapasite? (Kaç kg/ton taşıyacak?)";
        $prompts[] = "   - Tip? (Manuel/Elektrikli/Akülü?)";
        $prompts[] = "   - Kullanım yeri? (Depo/Soğuk oda/Paslanmaz gerekli mi?)";
        $prompts[] = "3. Kullanıcı DETAY verene kadar ÜRÜN GÖSTERME!";
        $prompts[] = "";
        $prompts[] = "**ÖRNEK DOĞRU YANIT:**";
        $prompts[] = "```";
        $prompts[] = "Tabii, size yardımcı olabilirim! 😊";
        $prompts[] = "";
        $prompts[] = "Size en uygun transpaleti bulabilmem için birkaç detay öğrenebilir miyim?";
        $prompts[] = "";
        $prompts[] = "- Kaç kg/ton taşıma kapasitesi istiyorsunuz?";
        $prompts[] = "- Manuel mi yoksa elektrikli mi tercih edersiniz?";
        $prompts[] = "- Nerede kullanacaksınız? (Depo, soğuk oda, vb.)";
        $prompts[] = "```";
        $prompts[] = "";
