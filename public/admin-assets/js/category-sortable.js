/**
 * Portfolio Category Sortable JavaScript
 */
...
document.addEventListener('livewire:initialized', function() {
    ...
    Livewire.on('refresh-sortable', () => {
        console.log('🔄 Manual category sortable refresh');
    ...
    function initCategorySortable() {
        ...
        if (!container) {
            console.error('❌ category-sortable-list container bulunamadı!');
            return;
        }

        const categoryItems = container.querySelectorAll('.category-item');
        console.log('📋 Bulunan category item sayısı:', categoryItems.length);

        if (categoryItems.length === 0) {
            console.warn('⚠️ Hiç category item bulunamadı - liste boş olabilir');
        }
        ...
        window.categorySortable = new Sortable(container, {
            ...
            onEnd: function(evt) {
                ...
                if (previousItem) {
                    ...
                    console.log('FIRST: Root category');
                    parentId = null;
                    depth = 0;
                }
                ...
                // DEBUG
                console.log('🚀 Category order changed:', {
                    items: items,
