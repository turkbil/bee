    ...
    <div class="card">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" wire:model="inputs.name"
                                            ...
                                            placeholder="{{ __('settingmanagement::admin.group_name_placeholder') }}">
                                        <label>{{ __('settingmanagement::admin.group_name') }} *</label>
                                        @error('inputs.name')
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <select wire:model.live="inputs.parent_id" id="parent-group-select"
                                            ...
                                            data-choices-placeholder="{{ __('settingmanagement::admin.parent_group_placeholder') }}">
                                            <option value="">{{ __('settingmanagement::admin.parent_group_placeholder') }}</option>
                                            @foreach($parentGroups as $group)
                                            <option value="{{ $group->id }}">{{ $group->name }}</option>
                                            @endforeach
                                        </select>
                                        <label>{{ __('settingmanagement::admin.parent_group') }}</label>
                                ...
                                <div id="prefix-field" class="col-md-12" style="display: {{ !empty($inputs['parent_id']) ? 'block' : 'none' }}">
                                    <div class="form-floating">
                                        <input type="text" wire:model="inputs.prefix"
                                            ...
                                            placeholder="{{ __('settingmanagement::admin.prefix_placeholder') }}">
                                        <label>{{ __('settingmanagement::admin.prefix') }}</label>
                                        @error('inputs.prefix')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-text mt-2 ms-2"><i class="fas fa-info-circle me-1"></i>{{ __('settingmanagement::admin.prefix_help') }}</div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <textarea wire:model="inputs.description"
                                            ...
                                            placeholder="{{ __('settingmanagement::admin.description_placeholder') }}"></textarea>
                                        <label>{{ __('settingmanagement::admin.description') }}</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="pretty p-default p-curve p-toggle p-smooth ms-1">
                                    ...
                                    <div class="state p-success p-on ms-2">
                                        <label>{{ __('settingmanagement::admin.active') }}</label>
                                    </div>
                                    <div class="state p-danger p-off ms-2">
                                        <label>{{ __('settingmanagement::admin.inactive') }}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                <label class="form-label">{{ __('settingmanagement::admin.icon') }}</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" wire:model="inputs.icon"
                                        ...
                                        placeholder="{{ __('settingmanagement::admin.icon_placeholder') }}">
                                </div>
                                <div class="form-text mt-2 ms-2"><i class="fas fa-info-circle me-1"></i>{{ __('settingmanagement::admin.icon_help') }}</div>
                                @error('inputs.icon')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
            <a href="{{ route('admin.settingmanagement.index') }}" class="btn btn-link text-decoration-none">
                <i class="fas fa-arrow-left me-2"></i>{{ __('settingmanagement::admin.cancel') }}
            </a>
                ...
                <button type="button" class="btn" wire:click="save(false)" wire:loading.attr="disabled"
                    ...
                    <span class="d-flex align-items-center">
                        <span class="ms-2" wire:loading.remove wire:target="save(false)">
                            <i class="fa-thin fa-plus me-2"></i> {{ __('settingmanagement::admin.save_and_continue') }}
                        </span>
                        <span class="ms-2" wire:loading wire:target="save(false)">
                            <i class="fa-duotone fa-solid fa-spinner fa-spin me-2"></i> {{ __('settingmanagement::admin.save_and_continue') }}
                        </span>
                    </span>
                </button>
                <button type="button" class="btn btn-primary ms-4" wire:click="save(true)"
                    ...
                    <span class="d-flex align-items-center">
                        <span class="ms-2" wire:loading.remove wire:target="save(true)">
                            <i class="fa-thin fa-floppy-disk me-2"></i> {{ __('settingmanagement::admin.save') }}
                        </span>
                        <span class="ms-2" wire:loading wire:target="save(true)">
                            <i class="fa-duotone fa-solid fa-spinner fa-spin me-2"></i> {{ __('settingmanagement::admin.save') }}
                        </span>
                    </span>
                </button>
            </div>
