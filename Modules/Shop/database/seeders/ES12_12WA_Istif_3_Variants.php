...
class ES12_12WA_Istif_3_Variants extends Seeder
{
    public function run(): void
    {
        $m = DB::table('shop_products')->where('sku', 'ES12-12WA')->first();
        if (!$m) {
        ...
        $variants = [
            [
                'sku' => 'ES12-12WA-1150-550',
                'variant_type' => 'catal-uzunlugu',
                'title' => 'İXTİF ES12-12WA - 1150 mm Çatal / 550 mm Aralık',
...
JSON,
            ...
            [
                'sku' => 'ES12-12WA-1220-685',
                'variant_type' => 'catal-uzunlugu',
                'title' => 'İXTİF ES12-12WA - 1220 mm Çatal / 685 mm Aralık',
...
JSON,
        ...
        $this->command->info('✅ Variants eklendi/güncellendi: ES12-12WA');
    }
}
