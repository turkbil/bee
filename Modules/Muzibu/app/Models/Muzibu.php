...
class Muzibu extends BaseModel implements TranslatableEntity, HasMedia
{
    use Sluggable, HasTranslations, HasSeo, HasFactory, HasMediaManagement;

    protected $primaryKey = 'muzibu_id';
    ...
    /**
     * ID accessor - muzibu_id'yi id olarak döndür
     */
    public function getIdAttribute()
    {
        return $this->muzibu_id;
    }
    ...
    {
        return $this->belongsTo(MuzibuCategory::class, 'muzibu_category_id', 'category_id');
    }
    ...
    {
        // Check if muzibu has any images in content
        $content = $this->getTranslated('body', app()->getLocale()) ?? $this->body;
    ...
    /**
     * Get or create SEO setting for this muzibu
     */
    ...
    {
        // Muzibu modülü için özel işlemler burada yapılabilir
        // Örneğin: Cache temizleme, sitemap güncelleme vb.

        \Log::info("Muzibu çevirisi tamamlandı", [
            'muzibu_id' => $this->muzibu_id,
    ...
    {
        return \Modules\Muzibu\Database\Factories\MuzibuFactory::new();
    }
    ...
    /**
     * Muzibu için locale-aware URL oluştur
    ...
    public function getUrl(?string $locale = null): string
    {
        ...
        $moduleSlug = \App\Services\ModuleSlugService::getSlug('Muzibu', 'show');
