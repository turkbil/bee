...
<div class="card">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item text-danger"
                                            wire:click.prevent="$dispatch('showDeleteModal', {'type': 'tenant', 'id': {{ $tenant->id }}, 'title': '{{ $tenant->data['name'] ?? $tenant->title ?? 'Bilinmeyen Ad' }}'})">
    ...
    <!-- DeleteModal bileşeni -->
    @include('tenantmanagement::modals.delete-modal')
