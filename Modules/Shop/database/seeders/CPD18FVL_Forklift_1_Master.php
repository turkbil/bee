...
class CPD18FVL_Forklift_1_Master extends Seeder {
    public function run(): void {
        $categoryId = 1; // Forklift
        $brandId = 1; // İXTİF
        $sku = 'CPD18FVL';
        $titleTr = 'İXTİF CPD18FVL - 1.8 Ton Li-Ion Forklift';

        DB::table('shop_products')->updateOrInsert(['sku' => $sku], [
            'sku' => $sku,
            'title' => json_encode(['tr' => $titleTr], JSON_UNESCAPED_UNICODE),
            'slug' => json_encode(['tr' => Str::slug($titleTr)], JSON_UNESCAPED_UNICODE),
            'short_description' => json_encode(['tr' => '1.8 ton kapasiteli, 80V/205Ah Li-Ion enerji sistemi ve 80V/35A entegre şarj cihazı ile çok vardiyalı çalışmaya hazır. Çift tahrikli 2×5.0 kW AC yapı, 1680 mm dönüş yarıçapı ve 1070 mm genişlikle dar alanlarda çevik manevra sağlar. Standart kaldırma 3000 mm, hız 13/14 km/s.'], JSON_UNESCAPED_UNICODE),
            'base_price' => 0.00,
            ...
            'technical_specs' => json_encode(json_decode(<<<'JSON'
                {
                    ...
                    "Çatala kadar uzunluk (l2)": "2100 mm",
                    "Toplam Genişlik (b1/b2)": "1070 mm",
                    "Çatal Ölçüleri (s/e/l)": "100×40×920 mm",
...
JSON
            ...
            'features' => json_encode(json_decode(<<<'JSON'
                [
                    ...
                    {
                        "icon": "arrows-alt",
                        "text": "Kompakt şasi ve küçük dönüş yarıçapı (1680 mm) ile çeviklik"
                    },
                    {
                        "icon": "shield-alt",
