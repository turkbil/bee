                ...
                @if($products->count() > 0)
                    ...
                    <div x-show="!loaded" class="flex justify-center items-center py-32">
                        <div class="flex flex-col items-center gap-4">
                            <div class="relative">
                                {{-- Outer rotating ring --}}
                                <div class="animate-spin rounded-full h-16 w-16 border-4 border-gray-200 dark:border-gray-700 border-t-blue-600"></div>
                                {{-- Inner pulse --}}
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <div class="h-8 w-8 bg-blue-600/20 rounded-full animate-ping"></div>
                                </div>
                            </div>
