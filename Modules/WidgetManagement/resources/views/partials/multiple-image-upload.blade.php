<div x-data="{ 
    ...
    handleDrop(event) {
        ...
        if (event.dataTransfer.files.length > 0) {
            @this.upload('temporaryMultipleImages.{{ $index }}', event.dataTransfer.files[0]);
        }
...
<div class="row align-items-center g-3">
    <div class="col-12 col-md-9">
        <div class="card" :class="{ 'border-primary': isDropping }">
            <div class="card-body">
                <div class="dropzone" onclick="document.getElementById('fileInput_multiple_{{ $index }}').click()">
                    ...
                    <input type="file" id="fileInput_multiple_{{ $index }}"
                        wire:model="temporaryMultipleImages.{{ $index }}" class="d-none"
                ...
                @error('temporaryMultipleImages.' . $index)
    ...
    <div class="col-12 col-md-3">
        <div class="card">
            <div class="card-body p-3">
                @if (isset($temporaryMultipleImages[$index]))
