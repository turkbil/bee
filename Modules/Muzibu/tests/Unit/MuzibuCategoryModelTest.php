...
/**
 * MuzibuCategory Model Unit Tests
 *
 * Model'in attribute'leri, relationship'leri,
 * scope'ları ve özel metodlarını test eder.
 */
class MuzibuCategoryModelTest extends TestCase
{

    /** @test */
    public function it_has_correct_fillable_attributes(): void
    {
        $category = new MuzibuCategory();
    ...
    public function active_scope_returns_only_active_categories(): void
    {
        ...
        $activeCategories = MuzibuCategory::active()->get();
    ...
    /** @test */
    public function it_has_muzibus_relationship(): void
    {
        $category = MuzibuCategory::factory()->create();

        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Relations\HasMany::class, $category->muzibus());
    }
    ...
    public function it_can_have_parent_category(): void
    {
        ...
        $child = MuzibuCategory::factory()->create(['parent_id' => $parent->category_id]);
    ...
    {
        $parent = MuzibuCategory::factory()->create();
        $child1 = MuzibuCategory::factory()->create(['parent_id' => $parent->category_id]);
        $child2 = MuzibuCategory::factory()->create(['parent_id' => $parent->category_id]);
    ...
    {
        $parent = MuzibuCategory::factory()->create(['parent_id' => null]);
        $child = MuzibuCategory::factory()->create(['parent_id' => $parent->category_id]);
        $grandchild = MuzibuCategory::factory()->create(['parent_id' => $child->category_id]);
    ...
    public function it_has_factory(): void
    {
        ...
        $this->assertInstanceOf(MuzibuCategory::class, $category);
        $this->assertDatabaseHas('muzibu_categories', ['category_id' => $category->category_id]);
    }
    ...
    {
        $category = MuzibuCategory::factory()->inactive()->create();
    ...
    public function it_prevents_circular_reference_in_depth_calculation(): void
    {
        ...
        $category = MuzibuCategory::factory()->create(['parent_id' => null]);
