...
<div class="px-4 sm:px-6 py-6 sm:py-8">
    ...
    <div class="flex items-center justify-center sm:justify-start gap-4 mb-8 sm:mb-10">
        ...
        <button
            ...
            <span class="absolute -bottom-8 left-1/2 -translate-x-1/2 px-3 py-1 bg-zinc-900 text-white text-xs rounded-lg whitespace-nowrap opacity-0 group-hover/add:opacity-100 transition-opacity pointer-events-none z-10">
                Playlist'e Ekle
            </span>
        </button>
    </div>
