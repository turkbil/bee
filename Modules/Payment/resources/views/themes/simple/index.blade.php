...
@section('module_content')
    @php
        ...
        $breadcrumbsArray = [
            ...
            ['label' => $moduleTitle ?? __('payment::front.general.payments')]
        ];
    @endphp
    ...
    <section class="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div class="container mx-auto py-4">
            ...
            <h1 class="text-2xl md:text-3xl font-bold font-heading text-gray-900 dark:text-white">{{ $moduleTitle ?? __('payment::front.general.payments') }}</h1>
        </div>
    </section>
            ...
            @else
                ...
                <div class="text-center py-16">
                    <div class="w-16 h-16 bg-gray-100 dark:bg-gray-800 rounded-xl flex items-center justify-center mx-auto mb-4">
                        <i class="fa-solid fa-credit-card text-gray-400 dark:text-gray-500 text-2xl"></i>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2 font-heading">{{ __('payment::front.general.no_payments_found') }}</h3>
                    <p class="text-gray-500 dark:text-gray-400 text-sm font-body">Yakında ödeme seçeneklerimiz burada listelenecek.</p>
                </div>
            @endif
        </div>
    </section>
