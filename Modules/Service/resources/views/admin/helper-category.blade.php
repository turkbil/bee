{{-- Modules/Service/resources/views/admin/helper-category.blade.php --}}
{{-- PreTitle --}}
@section('pretitle')
    {{ __('service::admin.category_management') }}
@endsection
        ...
        <div class="dropdown-menu dropdown-module-menu">
            <div class="module-menu-revert">
                ...
                @hasmoduleaccess('service', 'create')
                    <a href="{{ route('admin.service.category.manage') }}" class="dropdown-module-item btn btn-primary">
