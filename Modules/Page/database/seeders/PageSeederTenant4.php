...
/**
 * Page Seeder for Tenant4
 * Languages: en (only)
 */
class PageSeederTenant4 extends Seeder
{
    ...
    private function createSeoSetting($page, $title, $description): void
    {
        ...
        $page->seoSetting()->create([
            ...
            'keywords' => [
                'en' => ['saas platform', 'business automation', 'workflow management', 'team collaboration', 'business software']
            ],
            'focus_keywords' => [
                'tr' => 'saas platform',
                'en' => 'saas platform',
