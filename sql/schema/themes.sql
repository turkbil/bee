...
CREATE TABLE `themes` (
  ...
  UNIQUE KEY `themes_folder_name_unique` (`folder_name`),
  KEY `themes_is_active_index` (`is_active`),
  KEY `themes_is_default_index` (`is_default`),
  KEY `themes_default_active_idx` (`is_default`,`is_active`),
  KEY `themes_name_active_idx` (`name`,`is_active`)
) AUTO_INCREMENT=5 ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
