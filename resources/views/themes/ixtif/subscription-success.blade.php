    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-8">
            <div class="inline-block relative">
                <div class="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center pulse-glow">
        ...
        <div class="text-center mb-12">
            ...
            @else
                ...
                <p class="text-2xl md:text-3xl text-blue-400 font-bold mb-2">
                    <i class="fas fa-crown mr-2"></i>Premium Aboneliğin Aktif
                </p>
            @endif
            <p class="text-gray-400 text-lg mt-4">
                Artık tüm premium özelliklerin keyfini çıkarabilirsin
            </p>
        </div>

        {{-- Subscription Details Card --}}
        <div class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 mb-8 border-2 {{ $isTrial ? 'border-emerald-500 shadow-2xl shadow-emerald-500/30' : 'border-blue-500 shadow-2xl shadow-blue-500/30' }}">
            <div class="flex items-center justify-between mb-6 pb-6 border-b border-white/10">
                ...
                <div class="text-right">
                    ...
                    @else
                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 border border-blue-500/40 rounded-full">
                            <i class="fas fa-crown text-blue-400"></i>
                            <span class="text-blue-400 font-bold">Premium</span>
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="bg-black/30 rounded-xl p-6">
                    <div class="flex items-center gap-3 mb-2">
                        <i class="fas fa-hourglass-end text-blue-400 text-xl"></i>
        ...
        {{-- Features --}}
        <div class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 mb-8 border border-white/10">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <a href="{{ route('home') }}"
               class="flex-1 py-4 px-8 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 text-white rounded-xl font-bold text-lg text-center transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/50">
