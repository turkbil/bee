@php
    View::share('pretitle', __('service::admin.category_management'));
@endphp

<div wire:key="service-category-component" wire:id="service-category-component">
    {{-- Helper dosyası --}}
    @include('service::admin.helper-category')
                            ...
                            <div class="tab-pane fade show active" id="0" role="tabpanel">
                                    ...
                                    <div class="language-content" data-language="{{ $lang }}"
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text"
                                                ...
                                                placeholder="{{ __('service::admin.category_title') }}">
                                            <label>
                                                {{ __('service::admin.category_title') }}
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-select" wire:model.defer="parent_id">
                                        <option value="">{{ __('service::admin.main_category') }}</option>
                                    ...
                                    <label>{{ __('service::admin.parent_category') }}</label>
                                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <!-- Dinamik Başlık - Sol -->
                        <div class="col">
                            <h3 class="card-title mb-0">{{ __('service::admin.categories') }}</h3>
                            <p class="text-muted small mb-0">{{ __('service::admin.category_management') }}</p>
                        </div>
                        <!-- Ortadaki Loading -->
                            ...
                            <div class="d-flex align-items-center justify-content-end">
                                <div class="input-icon">
                                    ...
                                    <input type="text" wire:model.live.debounce.300ms="search" class="form-control"
                                        placeholder="{{ __('service::admin.search_categories') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div>
                                                        <span class="badge bg-blue-lt">{{ $item->services_count }}</span>
                                                    </div>
                                                    @endif
                                                    ...
                                                    <!-- Edit Button -->
                                                    <div>
                                                        <a href="{{ route('admin.service.category.manage', $item->category_id) }}"
                            ...
                            @empty
                                <div class="list-group-item py-4">
                                    <div class="empty">
                                        ...
                                        <p class="empty-title mt-2">{{ __('service::admin.no_categories_found') }}</p>
                                        <p class="empty-subtitle text-muted">{{ __('service::admin.no_results') }}</p>
                                    </div>
                                </div>
                            @endforelse
                        </div>
