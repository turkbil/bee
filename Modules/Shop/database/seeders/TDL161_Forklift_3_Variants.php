...
class TDL161_Forklift_3_Variants extends Seeder {
    public function run(): void {
        ...
        if (!$m) {$this->command->error('❌ Master bulunamadı: TDL-161'); return; }
        ...
        $variants = [
            ...
            [
                ...
                'long_description' => '<section><h2>4.5 m Serbest Kaldırma</h2><p>4.5 m mast ile tavan yüksekliği sınırlı alanlarda dahi etkili istifleme sağlanır. Serbest kaldırma sayesinde çatallar, mast yükseltmeden ürünleri raf seviyesine taşır ve kapı geçişlerinde toplam yüksekliği kontrol altında tutar.</p></section><section><h3>Performans</h3><p>Çift AC tahrik (5.4kW×2) rampalarda tutarlı çekiş sunar. 48V Li-Ion batarya fırsat şarjı ile vardiya boyu hazırdır. Elektromanyetik frenler güvenli ve öngörülebilir duruş sağlar.</p></section><section><h3>Uygulama</h3><p>Perakende, FMCG ve ilaç depolarında üst raf seviyelerine erişimde verimli çözümdür.</p></section>',
                'use_cases' => [
