...
class EFL_201_Forklift_3_Variants extends Seeder {
    public function run(): void {
        ...
        if (!$m) {$this->command->error('❌ Master bulunamadı: EFL201'); return; }
        ...
        $variants = [
            ...
            [
                ...
                'long_description' => '<section><h2>3F450: Triplex ile Yüksek Erişim</h2><p>Triplex 3F450 mast, serbest kaldırma kapasitesiyle kapalı girişlerde çalışırken kafes temasını azaltır; 4500 mm kaldırma ile çok katlı raf yapılarına erişir. 2085 mm kapalı yükseklik, alçak kapı ve yükleme noktalarında manevrayı kolaylaştırır. 80V/150Ah enerji sistemi ve hızlı fırsat şarjı, yüksek istif döngülerinde dahi temponuzu korur.</p></section><section><h3>Teknik Odak</h3><p>0.25/0.30 m/s kaldırma hızları, 70 dB(A) kabin içi gürültü ve 2100 mm dönüş yarıçapı, operatör verimliliğini artırır. 2A çatal arabası ve 40×122×1070 mm çatal ölçüleri farklı palet türlerine uyumu sürdürür.</p></section><section><h3>Sonuç</h3><p>3F450; hem alçak eşiklerde çalışıp hem de yüksek kotlara erişmesi gereken işletmeler için optimum çözümdür.</p></section>',
                'use_cases' => [
