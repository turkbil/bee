...
CREATE TABLE `widget_items` (
  ...
  `tenant_widget_id` bigint unsigned NOT NULL,
  `content` json DEFAULT NULL,
  `order` int NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `widget_items_created_at_index` (`created_at`),
  KEY `widget_items_updated_at_index` (`updated_at`),
  KEY `widget_items_tenant_order_idx` (`tenant_widget_id`,`order`),
