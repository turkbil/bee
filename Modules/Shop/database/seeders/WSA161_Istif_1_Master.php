...
class WSA161_Istif_1_Master extends Seeder {
    public function run(): void {
        $sku = 'WSA161';
        $titleTr = 'İXTİF WSA161 - 1.0 Ton Li-Ion İstif Makinesi';

        DB::table('shop_products')->updateOrInsert(['sku' => $sku], [
            'sku' => $sku,
            'title' => json_encode(['tr' => $titleTr], JSON_UNESCAPED_UNICODE),
            'slug' => json_encode(['tr' => Str::slug($titleTr)], JSON_UNESCAPED_UNICODE),
            'short_description' => json_encode(['tr' => 'WSA serisi, Li-Ion teknolojisi ve entegre şarj ile dar alanlarda yüksek verim sunan ağır hizmet yaya kumandalı istifleyicidir. 1600 kg kapasite, 774 mm l2, 1506 mm dönüş yarıçapı ve 5/5.5 km/s seyir hızlarıyla hızlı ve hassas istif sağlar; 24V/100Ah (205Ah opsiyonel) batarya ile esnek şarj imkanına sahiptir.'], JSON_UNESCAPED_UNICODE),
            'category_id' => 3,
            'brand_id' => 1,
            ...
            'technical_specs' => json_encode(json_decode(<<<'JSON'
                {
                    ...
                    "Batarya": "24V/100Ah (205Ah opsiyonel)"
                }
JSON
            ...
            'features' => json_encode(json_decode(<<<'JSON'
                [
                    ...
                    {
                        "icon": "arrows-alt",
                        "text": "Kompakt şasi ve 1506 mm dönüş yarıçapı ile dar alan çevikliği"
                    },
                    {
                        "icon": "shield-alt",
...
JSON
        ...
        $this->command->info('✅ Master: WSA161 oluşturuldu');
    }
}
