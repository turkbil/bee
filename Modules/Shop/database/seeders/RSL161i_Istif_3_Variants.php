...
class RSL161i_Istif_3_Variants extends Seeder {
    public function run(): void {
        ...
        if (!$m) {$this->command->error('❌ Master bulunamadı: RSL161i'); return; }
        $variants = [[
                'sku' => 'RSL161i-1150',
