                        ...
                        <div class="tab-content" id="contentTabContent">
                            ...
                            <div class="tab-pane fade show active" id="0" role="tabpanel">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <label>{{ __('muzibu::admin.parent_category') }}</label>
                                </div>
                            ...
                            <div class="d-flex align-items-center justify-content-end">
                                <div class="input-icon">
                                    ...
                                    <input type="text" wire:model.live.debounce.300ms="search" class="form-control"
                                        placeholder="{{ __('muzibu::admin.search_categories') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    <!-- Muzibu Count Badge -->
                                                    @if($item->muzibus_count > 0)
                                                    <div>
                                                        <span class="badge bg-blue-lt">{{ $item->muzibus_count }}</span>
                                                    </div>
                                                    @endif
                                                    ...
                                                    <!-- Edit Button -->
                                                    <div>
                                                        <a href="{{ route('admin.muzibu.category.manage', $item->category_id) }}"
