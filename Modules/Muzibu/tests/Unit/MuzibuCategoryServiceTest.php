...
/**
 * MuzibuCategoryService Unit Tests
 */
class MuzibuCategoryServiceTest extends TestCase
{
    private MuzibuCategoryService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->repositoryMock = Mockery::mock(MuzibuCategoryRepository::class);
        $this->service = new MuzibuCategoryService($this->repositoryMock);
    }
    ...
    {
        $category = MuzibuCategory::factory()->make(['category_id' => 1]);
    ...
    {
        $categories = collect([
            MuzibuCategory::factory()->make(['is_active' => true]),
            MuzibuCategory::factory()->make(['is_active' => true]),
        ]);
    ...
    /** @test */
    public function it_deletes_category_without_muzibus(): void
    {
        Log::shouldReceive('info')->once();

        $category = MuzibuCategory::factory()->make(['category_id' => 1]);
        $category->shouldReceive('muzibus')->andReturnSelf();
