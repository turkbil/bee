...
module.exports = {
    ...
    safelist: [
        ...
        'shadow-lg', 'shadow-muzibu-coral/30', 'shadow-muzibu-coral/50', 'shadow-pink-500/30',
        'hover:opacity-90', 'ring-muzibu-coral', 'ring-muzibu-coral/30', 'ring-muzibu-coral/50',
        'ring-offset-2', 'ring-offset-slate-900',
        'animate-ping', 'animate-pulse',
        'backdrop-blur-sm',
        'group-hover:animate-pulse', 'group-hover:-translate-x-0.5', 'group-hover:translate-x-0.5',
        'hover:scale-105',
