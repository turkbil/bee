    ...
    public function run(): void
    {
        ...
        $variants = [
            ...
            [
                ...
                'body' => '<section><h3>Uzun Paletlere Uyum</h3><p>1220 mm çatal, uzun paletler ve uzayan yük geometrilerinde ağırlık dağılımını iyileştirir. 60×190 mm kesit sertliği ve 24V/210Ah akü altyapısı; 1.6 ton nominal kapasiteyi güvenli şekilde sahaya taşır. 0.30/0.22 m/s indirme ve iki kademeli alçaltma, raflara yaklaşımda titreşimi azaltır.</p></section><section><h3>Hassas Manevra</h3><p>Elektronik direksiyon ve elektromanyetik fren sistemi; dar koridorlarda kontrollü hızlanma ve yumuşak duruş sağlar. 1730/2090 mm dönüş yarıçapı ile 850 mm şasi genişliği kombinasyonu, sıkışık zeminlerde çeviklik demektir.</p></section><section><h3>Uygulama Senaryoları</h3><p>İçecek kasaları, mobilya parçaları ve geniş yüzeyli kolilerde tek seferde güvenli taşıma ve düzenli istif sağlanır.</p></section>',
                'use_cases' => [
