...
class EFL181_Forklift_3_Variants extends Seeder {
    public function run(): void {
        ...
        if (!$m) {$this->command->error('❌ Master bulunamadı: EFL181'); return; }
