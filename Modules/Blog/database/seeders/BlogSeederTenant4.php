...
class BlogSeederTenant4 extends Seeder
{
    private $faker;

    public function run(): void
    {
        // Blog tablosu yoksa atla
        if (!Schema::hasTable('blogs')) {
            $this->command->warn("⚠️  Blog tablosu bulunamadı. Atlanıyor...");
            return;
        }
        ...
        $this->command->info('📝 Creating blogs with Faker...');
