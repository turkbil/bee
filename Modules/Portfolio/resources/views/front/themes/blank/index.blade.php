        ...
        <div class="portfolio-item overflow-hidden hover:shadow-sm transition-shadow duration-300">
            ...
            <div class="p-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">
                    <a href="{{ route('portfolios.show', $item->slug) }}" class="hover:text-primary dark:hover:text-primary-400 transition-colors duration-300">{{ $item->title }}</a>
                </h3>
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    <span class="flex items-center">
                        ...
                        <a href="{{ route('portfolios.category', $item->category->slug) }}" class="hover:text-primary dark:hover:text-primary-400">
                            {{ $item->category->title }}
                        </a>
                    </span>
                    @endif
