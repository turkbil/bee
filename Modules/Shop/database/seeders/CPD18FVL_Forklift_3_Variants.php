...
class CPD18FVL_Forklift_3_Variants extends Seeder
{
    public function run(): void
    {
        $m = DB::table('shop_products')->where('sku', 'CPD18FVL')->first();
        if (!$m) {
            $this->command->error('❌ Master bulunamadı (CPD18FVL)');
            return;
        }
        ...
        $variants = [
            ...
            [
                ...
                'title' => 'İXTİF CPD18FVL - 920 mm Çatal Forklift',
...
JSON,
            ...
            [
                'sku' => 'CPD18FVL-1070',
                'variant_type' => 'catal-uzunlugu',
                'title' => 'İXTİF CPD18FVL - 1070 mm Çatal Forklift',
                ...
                'body' => '<section><h2>1070 mm Çatal: Esneklik ve erişim</h2><p>Operasyonlarda palet ölçülerinin ve rampa koşullarının farklılaştığı alanlarda 1070 mm çatal, yükün ağırlık merkezine daha doğru erişim ve daha güvenli kavrama sağlar. Sürücüler raf derinliğine yaklaşırken palet ucunu daha rahat hizalar; iade ve çapraz sevkiyat gibi hızlı değişen akışlarda süreklilik artar.</p></section><section><h3>Teknik denge</h3><p>Uygun çatal boyu, yükün ön aksa binen momentini optimize eder. Palet çıkıntılarında şasiye çarpmayı azaltır, raf ayağına yaklaşırken daha öngörülebilir duruş sağlar. Farklı ataşman ve lastik seçenekleriyle birlikte, ürün bütün gün boyunca dengeli ve hızlı çalışır.</p></section><section><h3>Operasyonel sonuç</h3><p>Doğru konfigürasyonla yerden kazanım, daha az manevra ve daha düşük hasar oranı elde edilir. Entegre şarj ve Li‑Ion mimari, vardiya arasında fırsat şarjı ile süreklilik sağlar.</p></section>',
                'use_cases' => json_decode(
                    <<<'JSON'
                    [
                        {
...
JSON,
            ...
            [
                'sku' => 'CPD18FVL-1150',
                'variant_type' => 'catal-uzunlugu',
                'title' => 'İXTİF CPD18FVL - 1150 mm Çatal Forklift',
                ...
                'body' => '<section><h2>1150 mm Çatal: Esneklik ve erişim</h2><p>Operasyonlarda palet ölçülerinin ve rampa koşullarının farklılaştığı alanlarda 1150 mm çatal, yükün ağırlık merkezine daha doğru erişim ve daha güvenli kavrama sağlar. Sürücüler raf derinliğine yaklaşırken palet ucunu daha rahat hizalar; iade ve çapraz sevkiyat gibi hızlı değişen akışlarda süreklilik artar.</p></section><section><h3>Teknik denge</h3><p>Uygun çatal boyu, yükün ön aksa binen momentini optimize eder. Palet çıkıntılarında şasiye çarpmayı azaltır, raf ayağına yaklaşırken daha öngörülebilir duruş sağlar. Farklı ataşman ve lastik seçenekleriyle birlikte, ürün bütün gün boyunca dengeli ve hızlı çalışır.</p></section><section><h3>Operasyonel sonuç</h3><p>Doğru konfigürasyonla yerden kazanım, daha az manevra ve daha düşük hasar oranı elde edilir. Entegre şarj ve Li‑Ion mimari, vardiya arasında fırsat şarjı ile süreklilik sağlar.</p></section>',
                'use_cases' => json_decode(
                    <<<'JSON'
                    [
                        {
...
JSON,
            ...
            [
                'sku' => 'CPD18FVL-1220',
                'variant_type' => 'catal-uzunlugu',
                'title' => 'İXTİF CPD18FVL - 1220 mm Çatal Forklift',
                ...
                'body' => '<section><h2>1220 mm Çatal: Esneklik ve erişim</h2><p>Operasyonlarda palet ölçülerinin ve rampa koşullarının farklılaştığı alanlarda 1220 mm çatal, yükün ağırlık merkezine daha doğru erişim ve daha güvenli kavrama sağlar. Sürücüler raf derinliğine yaklaşırken palet ucunu daha rahat hizalar; iade ve çapraz sevkiyat gibi hızlı değişen akışlarda süreklilik artar.</p></section><section><h3>Teknik denge</h3><p>Uygun çatal boyu, yükün ön aksa binen momentini optimize eder. Palet çıkıntılarında şasiye çarpmayı azaltır, raf ayağına yaklaşırken daha öngörülebilir duruş sağlar. Farklı ataşman ve lastik seçenekleriyle birlikte, ürün bütün gün boyunca dengeli ve hızlı çalışır.</p></section><section><h3>Operasyonel sonuç</h3><p>Doğru konfigürasyonla yerden kazanım, daha az manevra ve daha düşük hasar oranı elde edilir. Entegre şarj ve Li‑Ion mimari, vardiya arasında fırsat şarjı ile süreklilik sağlar.</p></section>',
                'use_cases' => json_decode(
                    <<<'JSON'
                    [
                        {
...
JSON,
        ...
        $this->command->info("✅ Variants: CPD18FVL (" . count($variants) . " adet)");
    }
}
