...
class EFX5_251_Forklift_3_Variants extends Seeder {
    public function run(): void {
        $m = DB::table('shop_products')->where('sku', 'EFX5-251')->first();
        if (!$m) {$this->command->error('❌ Master bulunamadı: EFX5-251'); return; }
        ...
        $variants = [
            ...
            [
                ...
                'title' => 'İXTİF EFX5 251 - 80V 280Ah Tek Modül',
...
JSON
        ...
        ,
            ...
            [
                'sku' => 'EFX5-251-B560',
                'variant_type' => 'batarya-tipi',
                'title' => 'İXTİF EFX5 251 - 80V 560Ah Çift Modül',
...
JSON
        ...
        ,
            ...
            [
                ...
                'title' => 'İXTİF EFX5 251 - 4.5 m Direk',
