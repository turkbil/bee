...
class ES14_30WA_Istif_3_Variants extends Seeder {
    public function run(): void {
        ...
        if (!$m) {$this->command->error('❌ Master bulunamadı (ES14-30WA)'); return; }
        ...
        $variants = [
            ...
            [
                ...
                'long_description' => '<section><h3>1150 mm Çatal: EUR Palet Ustası</h3><p>EUR paletlerde yaygın kullanılan 1150 mm uzunluk, yük merkezine uyumlu ağırlık dağılımı sunar. 4115 mm açık mast yüksekliği ile üst seviye raflara erişim, titreşim kontrolü ve hassas duruş birlikte sağlanır.</p></section><section><h3>Performans</h3><p>3.0 kW kaldırma motoru büyük yüklerde stabil hız sağlarken, 24V enerji altyapısı gün boyu kararlı performans verir. Elektromanyetik fren, eğimde geri kaymayı önlemeye yardımcıdır.</p></section><section><h3>Kullanım Örnekleri</h3><p>Gıda, kozmetik ve elektronik depolarda standart palet akışı ile hatasız istifleme sunar.</p></section>',
                'use_cases' => [
