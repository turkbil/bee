...
/**
 * PaymentCategoryService Unit Tests
 */
class PaymentCategoryServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repositoryMock = Mockery::mock(PaymentCategoryRepository::class);
        $this->service = new PaymentCategoryService($this->repositoryMock);
    }
    ...
    {
        $category = PaymentCategory::factory()->make(['category_id' => 1]);
    ...
    {
        $categories = collect([
            PaymentCategory::factory()->make(['is_active' => true]),
            PaymentCategory::factory()->make(['is_active' => true]),
        ]);
    ...
    /** @test */
    public function it_deletes_category_without_payments(): void
    {
        Log::shouldReceive('info')->once();

        $category = PaymentCategory::factory()->make(['category_id' => 1]);
        $category->shouldReceive('payments')->andReturnSelf();
