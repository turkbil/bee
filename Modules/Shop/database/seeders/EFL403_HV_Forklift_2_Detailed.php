...
class EFL403_HV_Forklift_2_Detailed extends Seeder {
    public function run(): void {
        $p = DB::table('shop_products')->where('sku', 'EFL403-HV')->first();
        if (!$p) {$this->command->error('❌ Master bulunamadı'); return; }

        DB::table('shop_products')->where('product_id', $p->product_id)->update([
            'long_description' => json_encode(['tr' => '<section><h2>İXTİF EFL403 HV - 4.0 Ton Yüksek Voltaj Elektrikli Forklift: Yüksek Voltajla Ağır İşlerin Yeni Standardı</h2>
<p>İXTİF EFL403 HV - 4.0 Ton Yüksek Voltaj Elektrikli Forklift, 4000 kg ton sınıfında yüksek voltajlı Li-ion mimariyi PMSM sürüş ile birleştirerek, ağır hizmet operasyonlarında hızlanma, dur kalk tepkisi ve rampa performansını yeniden tanımlar. 309V mimari ve gelişmiş BMS ile akü ömrü uzun, 1C hızlı şarj desteğiyle kesintiler kısadır. 500 mm mm yük merkeziyle dengeli taşıma sunarken, tek ön teker mimarisi ve kompakt şasi dar alan manevralarını kolaylaştırır.</p></section>
...
<section><h3>Sonuç</h3>
<p>Toplam sahip olma maliyetini düşüren düşük enerji tüketimi ve minimal bakım gereksinimi ile İXTİF EFL403 HV - 4.0 Ton Yüksek Voltaj Elektrikli Forklift, şirketlerin yüksek hacimli taşıma gereksinimlerine temiz, hızlı ve güvenli bir çözüm sunar. Detaylı fiyatlama ve demo için 0216 755 3 555.</p></section>'], JSON_UNESCAPED_UNICODE),
            'primary_specs' => json_encode([
                ['icon' => 'weight-hanging', 'label' => 'Kapasite', 'value' => '4000 kg'],
                ['icon' => 'battery-full', 'label' => 'Batarya', 'value' => '309V/173Ah'],
                ['icon' => 'gauge', 'label' => 'Sürüş Hızı', 'value' => '24/25 km/s'],
                ['icon' => 'arrows-alt', 'label' => 'Dönüş Yarıçapı', 'value' => '2680 mm']
        ...
        $this->command->info("ℹ️ Detailed güncellendi: EFL403-HV");
    }
}
