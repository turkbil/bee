<div>
    @php
        View::share(
            'pretitle',
            $categoryId ? __('blog::admin.edit_category') : __('blog::admin.new_category'),
        );
    @endphp
    ...
    <form method="post" wire:submit.prevent="save">
        ...
        <div class="card">
                        ...
                        @foreach ($availableLanguages as $lang)
                            ...
                            <div class="language-content" data-language="{{ $lang }}"
                                ...
                                @include('admin.components.content-editor', [
                                    ...
                                    'label' => __('blog::admin.category_description'),
                                    'placeholder' => __('blog::admin.category_description_placeholder'),
                                ])
                            </div>
                        @endforeach
            ...
            <x-form-footer route="admin.blog.category.index" :model-id="$categoryId" />
    ...
    @push('scripts')
        ...
        <script>
            ...
            window.currentModuleName = 'blog_category';
