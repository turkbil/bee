...
/**
 * PortfolioCategoryService Unit Tests
 */
class PortfolioCategoryServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repositoryMock = Mockery::mock(PortfolioCategoryRepository::class);
        $this->service = new PortfolioCategoryService($this->repositoryMock);
    }
    ...
    {
        $category = PortfolioCategory::factory()->make(['category_id' => 1]);
    ...
    {
        $categories = collect([
            PortfolioCategory::factory()->make(['is_active' => true]),
            PortfolioCategory::factory()->make(['is_active' => true]),
        ]);
    ...
    /** @test */
    public function it_deletes_category_without_portfolios(): void
    {
        Log::shouldReceive('info')->once();

        $category = PortfolioCategory::factory()->make(['category_id' => 1]);
        $category->shouldReceive('portfolios')->andReturnSelf();
