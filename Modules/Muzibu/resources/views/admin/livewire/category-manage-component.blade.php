<div>
    @php
        View::share(
            'pretitle',
            $categoryId ? __('muzibu::admin.edit_category') : __('muzibu::admin.new_category'),
        );
    @endphp
    ...
    <form method="post" wire:submit.prevent="save">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="tab-content" id="contentTabContent">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input type="text" wire:model="multiLangInputs.{{ $lang }}.title"
                                                ...
                                                placeholder="{{ __('muzibu::admin.category_title') }}">
                                            <label>
                                                {{ __('muzibu::admin.category_title') }}
                            ...
                            <div class="col-12 col-md-6 mb-3 mb-md-0">
                                <div class="form-floating">
                                    <select wire:model="inputs.parent_id"
                                        ...
                                        <option value="">{{ __('muzibu::admin.main_category') }}</option>
                                    ...
                                    <label for="parent_category_select">
                                        {{ __('muzibu::admin.parent_category') }}
                                    </label>
                        ...
                        @foreach ($availableLanguages as $lang)
                            ...
                            <div class="language-content" data-language="{{ $lang }}"
                                ...
                                @include('admin.components.content-editor', [
                                    ...
                                    'label' => __('muzibu::admin.category_description'),
                                    'placeholder' => __('muzibu::admin.category_description_placeholder'),
                                ])
                            </div>
                        @endforeach
                    ...
                    <div class="tab-pane" id="1" role="tabpanel">
                        <livewire:seomanagement::universal-seo-tab :model-id="$categoryId" model-type="muzibu_category"
                            model-class="Modules\Muzibu\App\Models\MuzibuCategory" />
                    </div>
            ...
            <x-form-footer route="admin.muzibu.category.index" :model-id="$categoryId" />
    ...
    @push('scripts')
        ...
        <script>
            ...
            window.currentModuleName = 'muzibu_category';
