...
class BlogCategory extends BaseModel implements TranslatableEntity, HasMedia
{
    ...
    {
        return $this->hasMany(Blog::class, 'blog_category_id', 'category_id');
    }
    ...
    protected function getSeoFallbackCanonicalUrl(): ?string
    {
        ...
        if ($slug) {
            return url('/blog/category/' . ltrim($slug, '/'));
        }
    ...
    {
        \Log::info("Blog Category çevirisi tamamlandı", [
            'category_id' => $this->category_id,
