...
class EFX5_381_Forklift_3_Variants extends Seeder {
    public function run(): void {
        $m = DB::table('shop_products')->where('sku', 'EFX5-381')->first();
        if (!$m) {$this->command->error('❌ Master bulunamadı: EFX5-381'); return; }
        ...
        $variants = [
            ...
            [
                ...
                'title' => 'İXTİF EFX5 381 - 80V 280Ah Tek Modül',
...
JSON
        ...
        ,
            ...
            [
                'sku' => 'EFX5-381-B560',
                'variant_type' => 'batarya-tipi',
                'title' => 'İXTİF EFX5 381 - 80V 560Ah Çift Modül',
...
JSON
        ...
        ,
            ...
            [
                ...
                'title' => 'İXTİF EFX5 381 - 4.5 m Direk',
