...
@section('module_content')
    @php
        ...
        $favoriteIndexUrl = $localePrefix . '/' . $indexSlug;
        ...
        $breadcrumbsArray = [
            ...
            ['label' => __('favorite::front.general.favorites'), 'url' => url($favoriteIndexUrl)],
            ['label' => $title]
        ];
    @endphp
                    ...
                    <aside class="lg:col-span-2">
                        <div class="sticky top-24 space-y-6">
                            ...
                            <figure class="rounded-2xl overflow-hidden shadow-2xl">
                                <a href="{{ $featuredImage->getUrl() }}" class="glightbox block" data-gallery="favorite-main">
