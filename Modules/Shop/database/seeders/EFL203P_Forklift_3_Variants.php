    ...
    public function run(): void
    {
        ...
        $variants = [
            ...
            [
                ...
                'body' => '<section><h3>Uzun menzil, yüksek tempo</h3><p>460Ah Li-Ion, rampa ve dur-kalk yoğun operasyonlarda daha uzun aralıksız çalışma sağlar. BMS, ısı ve akım yönetimiyle güç teslimi stabil kalır; vardiya planlamasında şarj pencereleri seyrekleşir.</p></section><section><h3>Operasyonel avantaj</h3><p>Yüksek hız ve tırmanma kapasitesi ile birleşen büyük batarya, tur başına süreyi kısaltırken saatlik çıktı miktarını artırır.</p></section><section><h3>Planlama</h3><p>Şarj altyapısı üzerindeki baskı azalır; filo kullanım oranı ve görev eşlemesi daha esnek hâle gelir.</p></section>',
                'use_cases' => [
