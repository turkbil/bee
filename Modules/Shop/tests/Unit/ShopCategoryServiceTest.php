...
/**
 * ShopCategoryService Unit Tests
 */
class ShopCategoryServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repositoryMock = Mockery::mock(ShopCategoryRepository::class);
        $this->service = new ShopCategoryService($this->repositoryMock);
    }
    ...
    {
        $category = ShopCategory::factory()->make(['category_id' => 1]);
    ...
    {
        $categories = collect([
            ShopCategory::factory()->make(['is_active' => true]),
            ShopCategory::factory()->make(['is_active' => true]),
        ]);
    ...
    /** @test */
    public function it_deletes_category_without_shops(): void
    {
        Log::shouldReceive('info')->once();

        $category = ShopCategory::factory()->make(['category_id' => 1]);
        $category->shouldReceive('shops')->andReturnSelf();
