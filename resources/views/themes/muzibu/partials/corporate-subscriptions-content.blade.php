{{-- Corporate Subscriptions Content (SPA partial) --}}
@php
...
document.addEventListener('alpine:init', () => {
    Alpine.data('corporateSubscriptionsSPA', () => ({
        // Data (inline for SPA)
        plans: {!! $plansJson !!},
        members: {!! $membersJson !!},
...
<div x-data="corporateSubscriptionsSPA" x-init="init()" class="min-h-screen pb-24">
