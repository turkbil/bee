...
<div id="widget-form-builder-app">
    <div class="studio-header">
        ...
        <div class="header-right">
            <a href="{{ route('admin.widgetmanagement.manage', $widget->id) }}" id="back-btn" class="btn-back me-2" title="Geri">
                    ...
                    <div id="form-canvas" class="p-3">
                        <div class="empty-canvas" id="empty-canvas">
                            <div class="text-center">
                                ...
                                <h3 class="text-muted">Widget Form Oluşturmaya Başlayın</h3>
    ...
    <input type="hidden" id="widget-id" value="{{ $widget->id }}">
