...
use Modules\Service\App\Contracts\ServiceCategoryRepositoryInterface;
use Modules\Service\App\Models\ServiceCategory;
use Modules\Service\App\Enums\CacheStrategy;

readonly class ServiceCategoryRepository implements ServiceCategoryRepositoryInterface
{
    ...
    public function __construct(
        private ServiceCategory $model
    ) {
        $this->cachePrefix = 'service_categories';
