...
use Modules\Blog\App\Jobs\TranslateBlogJob;
 ...
 */
class BlogTranslationIntegrationTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_dispatches_translation_job_to_queue()
    {
        ...
        Queue::assertPushed(TranslateBlogJob::class, function ($job) {
    ...
    public function it_handles_translation_job_failure_gracefully()
    {
        ...
        Queue::assertPushed(TranslateBlogJob::class);
    }

    /** @test */
    public function it_validates_blog_exists_before_translation()
    {
        $this->expectException(\Exception::class);

        $nonExistentId = 99999;

        $job = new TranslateBlogJob(
            [$nonExistentId],
            'tr',
            ['en'],
            'balanced',
        ...
        // Job should fail when blog not found
        $this->assertFalse(Blog::find($nonExistentId));
    }
    ...
    public function it_prevents_duplicate_translation_sessions()
    {
        ...
        Queue::assertPushedTimes(TranslateBlogJob::class, 1);
    }
}
