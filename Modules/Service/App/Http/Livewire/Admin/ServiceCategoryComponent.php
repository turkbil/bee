...
class ServiceCategoryComponent extends Component
{
    ...
    public function boot(ServiceCategoryService $categoryService): void
    {
    ...
    public function mount(): void
    {
        ...
        $this->tabConfig = [
            ['name' => __('service::admin.new_category'), 'icon' => 'fas fa-plus']
        ];
    ...
    public function addCategory(): void
    {
        ...
        try {
            ...
            $maxOrder = ServiceCategory::max('sort_order') ?? -1;
    ...
    public function editCategory(int $categoryId): void
    {
        try {
            ...
            $this->dispatch('toast', [
                'title' => __('admin.success'),
                'message' => __('service::admin.category_loaded_for_editing'),
                'type' => 'info',
            ]);
            ...
            $this->dispatch('toast', [
                'title' => __('admin.error'),
                'message' => __('service::admin.category_load_failed'),
                'type' => 'error',
            ]);
        }
    }
    ...
    public function toggleCategoryStatus(int $categoryId): void
    {
        try {
            ...
            $this->dispatch('toast', [
                'title' => __('admin.error'),
                'message' => __('service::admin.category_status_update_failed'),
                'type' => 'error',
            ]);
        }
    }
        ...
        try {
            ...
            foreach ($items as $item) {
                if (isset($item['id']) && isset($item['order'])) {
                    ...
                    ServiceCategory::where('category_id', $item['id'])
                        ->update($updateData);
                }
            }
            ...
            $this->dispatch('toast', [
                'title' => __('admin.success'),
                'message' => __('service::admin.category_order_updated'),
                'type' => 'success',
                'duration' => 3000
            ]);
    ...
    public function switchLanguage($language)
    {
        if (in_array($language, $this->availableLanguages)) {
            ...
            \Log::info('🎯 ServiceCategoryComponent switchLanguage', [
    ...
    {
        return view('service::admin.livewire.category-component', [
