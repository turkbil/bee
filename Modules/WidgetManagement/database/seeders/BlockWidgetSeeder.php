...
class BlockWidgetSeeder extends Seeder
{
    ...
    private function createBlockWidgets()
    {
        ...
        $blockDescriptions = [
            ...
            'layout/two-columns-8-4' => 'İki sütunlu yerleşim (8-4)',
            'layout/two-columns-4-8' => 'İki sütunlu yerleşim (4-8)',
            'layout/two-columns-9-3' => 'İki sütunlu yerleşim (9-3)',
            'layout/two-columns-3-9' => 'İki sütunlu yerleşim (3-9)',
            'layout/two-columns-7-5' => 'İki sütunlu yerleşim (7-5)',
            'layout/two-columns-5-7' => 'İki sütunlu yerleşim (5-7)',
            'layout/five-columns' => 'Beş sütunlu yerleşim',
            'layout/four-columns' => 'Dört sütunlu yerleşim',
            'layout/two-columns-2-10' => 'İki sütunlu yerleşim (2-10)',
            'layout/two-columns-10-2' => 'İki sütunlu yerleşim (10-2)',
            'layout/two-columns-6-6' => 'İki sütunlu yerleşim (6-6)',
            'layout/sidebar-main-sidebar' => 'Sol kenar - Ana içerik - Sağ kenar',
            'layout/stacked-columns' => 'Üst alt sütunlar',
            'layout/asymmetric-grid' => 'Asimetrik grid yerleşim',
            'layout/masonry-grid' => 'Masonry tipi grid yerleşim',
