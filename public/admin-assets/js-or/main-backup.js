...
function initializeChoices() {
    ...
    choicesElements.forEach(function(element) {
        ...
        // perPage selectbox'larını atla - normal select olarak kalsın
        if (element.getAttribute('wire:model.live') === 'perPage') {
            console.log('⏭️ Skipping perPage element - will be normal select');
            return;
        }
