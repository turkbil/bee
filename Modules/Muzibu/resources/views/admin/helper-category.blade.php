{{-- Modules/Muzibu/resources/views/admin/helper-category.blade.php --}}
{{-- PreTitle --}}
@section('pretitle')
    {{ __('muzibu::admin.category_management') }}
@endsection
        ...
        <div class="dropdown-menu dropdown-module-menu">
            <div class="module-menu-revert">
                ...
                @hasmoduleaccess('muzibu', 'create')
                    <a href="{{ route('admin.muzibu.category.manage') }}" class="dropdown-module-item btn btn-primary">
