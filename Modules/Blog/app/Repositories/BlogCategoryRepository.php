...
use Modules\Blog\App\Contracts\BlogCategoryRepositoryInterface;
use Modules\Blog\App\Models\BlogCategory;
use Modules\Blog\App\Enums\CacheStrategy;

readonly class BlogCategoryRepository implements BlogCategoryRepositoryInterface
{
    ...
    public function __construct(
        ...
        $this->cachePrefix = 'blog_categories';
    ...
    public function findByIdWithSeo(int $id): ?BlogCategory
    {
        $strategy = CacheStrategy::fromRequest();
