                    ...
                    <tr class="hover-trigger" wire:key="row-{{ $announcement->announcement_id }}">
                        ...
                        <td wire:key="title-{{ $announcement->announcement_id }}" class="position-relative">
                            ...
                            <div class="d-flex align-items-center">
                                <span class="editable-title pr-4">{{ $announcement->getTranslated('title', $currentSiteLocale) ?? $announcement->getTranslated('title', 'tr') }}</span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <button type="button" class="btn p-0 border-0 bg-transparent"
                                                onclick="openTranslationModal('announcement', {{ $announcement->announcement_id }})"
                                        ...
                                        <div class="dropdown mt-1">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a href="javascript:void(0);" wire:click="$dispatch('showDeleteModal', {
                                                    ...
                                                    title: '{{ addslashes($announcement->getTranslated('title', $currentSiteLocale) ?? $announcement->getTranslated('title', 'tr')) }}'
