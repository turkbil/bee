...
class EFX5_351_Forklift_1_Master extends Seeder {
    public function run(): void {
        $categoryId = 1; // Forklift
        $brandId = 1; // İXTİF
        $sku = 'EFX5-351';
        $titleTr = 'İXTİF EFX5 351 - 3. Ton Li-Ion Forklift';

        DB::table('shop_products')->updateOrInsert(['sku' => $sku], [
            'sku' => $sku,
            'title' => json_encode(['tr' => $titleTr], JSON_UNESCAPED_UNICODE),
            'slug' => json_encode(['tr' => Str::slug($titleTr)], JSON_UNESCAPED_UNICODE),
            'short_description' => json_encode(['tr' => '3. ton kapasiteli, 80V Li-Ion modüler akü (80V/280Ah (tek), 80V/560Ah (çift)), 16/17 km/s seyir, 0.44/0.55 m/s kaldırma ve 18/25% eğim performansı. 150 mm yerden yükseklik, geniş lastikler ve artırılmış görüşlü yeni direk ile 2498 mm dönüş yarıçapında verimli ve güvenli çalışma.'], JSON_UNESCAPED_UNICODE),
            'base_price' => 0.00,
            ...
            'technical_specs' => json_encode(json_decode(<<<'JSON'
                {
                    ...
                    "Toplam Uzunluk (l1)": "—",
                    "Çatala Kadar Uzunluk (l2)": "2754 mm",
                    "Toplam Genişlik (b1/b2)": "1230 mm",
                    "Çatal Ölçüleri (s×e×l)": "50×122×1070 mm",
                    "Dönüş Yarıçapı (Wa)": "2498 mm",
                    "Koridor Genişliği 1000×1200 (Ast)": "4184 mm",
                    "Koridor Genişliği 800×1200 (Ast)": "4384 mm",
                    "Seyir Hızı (Yüklü/Boş)": "16/17 km/s",
                    "Kaldırma Hızı (Yüklü/Boş)": "0.44/0.55 m/s",
                    "İndirme Hızı (Yüklü/Boş)": "0.5/0.44 m/s",
                    "Maks. Tırmanma (Yüklü/Boş)": "18/25%",
                    ...
                    "Ön Lastik": "28×9-15-14PR",
                    "Arka Lastik": "6.50-10-10PR",
