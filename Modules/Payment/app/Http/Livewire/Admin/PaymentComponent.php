...
use Modules\Payment\App\Http\Livewire\Traits\{InlineEditTitle, WithBulkActions};
use Modules\Payment\App\Services\PaymentService;
use Modules\LanguageManagement\App\Models\TenantLanguage;
use Modules\Payment\App\DataTransferObjects\PaymentOperationResult;
...
class PaymentComponent extends Component
{
    ...
    {
        \Log::info('🎉 NURU: PaymentComponent - TranslationCompleted event received', $eventData);

        // Frontend'e completion event'ini dispatch et
        $this->dispatch('translation-complete', [
            'success' => true,
            'sessionId' => $eventData['sessionId'] ?? null,
            'entityType' => $eventData['entityType'] ?? 'payment',
    ...
    {
        return \Modules\Payment\App\Models\Payment::class;
    }
    ...
    {
        try {
            $result = $this->paymentService->togglePaymentStatus($id);
    ...
    public function render(): \Illuminate\Contracts\View\View
    {
        ...
        $payments = $this->paymentService->getPaginatedPayments($filters, (int) $this->perPage);

        return view('payment::admin.livewire.payment-component', [
            'payments' => $payments,
    ...
    public function translateFromModal(array $data): array
    {
        try {
            ...
            // TranslatePaymentJob kullanarak async çeviri başlat
            $paymentId = $data['entityId'] ?? null;
            if (!$paymentId) {
            ...
            // Job'u kuyruğa ekle
            Log::info('📦 TranslatePaymentJob kuyruğa ekleniyor', [
            ...
            $job = \Modules\Payment\App\Jobs\TranslatePaymentJob::dispatch(
                [$paymentId], // Array olarak gönder
            ...
            Log::info('✅ TranslatePaymentJob başarıyla kuyruğa eklendi', [
