...
class F4_201_Transpalet_3_Variants extends Seeder {
    public function run(): void {
        ...
        if (!$m) {$this->command->error('❌ Master bulunamadı (F4-201)'); return; }
        ...
        $variants = [
            ...
            [
                ...
                'long_description' => '<section><h3>1150×685 mm: geniş tabanlı paletler için</h3><p>685 mm çatal aralığı, geniş tabanlı paletlerde ek stabilite sağlar. 1150 mm boy, standart palet derinlikleriyle uyumludur. 48V sistem güç kaybını minimize eder, 2 tonluk nominal kapasite işletme hızını korur.</p></section><section><h3>Güvenlik ve dayanıklılık</h3><p>Elektromanyetik fren, sağlam şasi ve opsiyonel stabilizasyon tekerleri düzensiz zeminlerde bile güvenilir idare sunar. BLDC sürüş kontrolü akıcı hızlanma sağlar.</p></section><section><h3>Operasyon senaryoları</h3><p>Gıda‑içecek depolarında soğuk oda giriş‑çıkışı, mobilya ve beyaz eşya dağıtım merkezlerinde geniş ebatlı yüklerde öne çıkar.</p></section>',
                'use_cases' => [
