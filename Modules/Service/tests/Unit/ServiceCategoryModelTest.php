...
class ServiceCategoryModelTest extends TestCase
{
    ...
    /** @test */
    public function it_has_services_relationship(): void
    {
        $category = ServiceCategory::factory()->create();

        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Relations\HasMany::class, $category->services());
    }
    ...
    public function it_can_have_parent_category(): void
    {
        ...
        $child = ServiceCategory::factory()->create(['parent_id' => $parent->category_id]);
    ...
    {
        $parent = ServiceCategory::factory()->create();
        $child1 = ServiceCategory::factory()->create(['parent_id' => $parent->category_id]);
        $child2 = ServiceCategory::factory()->create(['parent_id' => $parent->category_id]);
    ...
    {
        $parent = ServiceCategory::factory()->create(['parent_id' => null]);
        $child = ServiceCategory::factory()->create(['parent_id' => $parent->category_id]);
        $grandchild = ServiceCategory::factory()->create(['parent_id' => $child->category_id]);
    ...
    public function it_has_factory(): void
    {
        ...
        $this->assertDatabaseHas('service_categories', ['category_id' => $category->category_id]);
    }
    ...
    public function it_prevents_circular_reference_in_depth_calculation(): void
    {
        ...
        $category = ServiceCategory::factory()->create(['parent_id' => null]);
