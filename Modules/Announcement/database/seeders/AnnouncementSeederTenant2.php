...
/**
 * Announcement Seeder for Tenant 2 - Digital Agency
 *
...
class AnnouncementSeederTenant2 extends Seeder
{
    ...
    {
        $this->command->info('🚀 Starting Tenant 2 Announcement Seeding...');
    ...
    /**
     * Create services/products announcement
     */
    ...
    private function createMainMenu(): void
    {
        ...
        MenuItem::create([
            ...
            'url_type' => 'announcement',
            'url_data' => ['announcement' => 'homepage'],
            'target' => '_self',
            'sort_order' => 1,
            'is_active' => true,
        ]);
        ...
        MenuItem::create([
            ...
            'url_type' => 'announcement',
            'url_data' => ['announcement' => 'about-us'],
            'target' => '_self',
            'sort_order' => 2,
            'is_active' => true,
        ]);
        ...
        MenuItem::create([
            ...
            'url_type' => 'announcement',
            'url_data' => ['announcement' => 'services'],
            'target' => '_self',
            'sort_order' => 3,
            'is_active' => true,
        ]);
        ...
        MenuItem::create([
            ...
            'url_type' => 'announcement',
            'url_data' => ['announcement' => 'ecommerce-solutions'],
            'target' => '_self',
            'sort_order' => 4,
            'is_active' => true,
        ]);
