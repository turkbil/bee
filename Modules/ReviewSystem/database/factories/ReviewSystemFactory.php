...
namespace Modules\ReviewSystem\Database\Factories;
 ...
 *
 * @extends Factory<ReviewSystem>
 */
class ReviewSystemFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = ReviewSystem::class;
    ...
    /**
     * Privacy policy reviewsystem state
