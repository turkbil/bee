        ...
        <div class="lg:hidden space-y-3">
            ...
            @foreach($mainCategories as $category)
                ...
                <a href="/shop/kategori/{{ $categorySlug }}"
                   class="flex items-center gap-3 bg-white/70 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-gray-600 rounded-xl p-4 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200">

                    {{-- Icon --}}
                    <div class="w-12 h-12 bg-white/40 dark:bg-white/10 backdrop-blur-md rounded-xl flex items-center justify-center flex-shrink-0 border border-gray-200 dark:border-gray-600">
            ...
            <div class="pt-2 space-y-2">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="bg-white/70 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-2 text-center hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200 cursor-pointer">
        ...
        <div class="hidden lg:grid grid-cols-12 gap-8">
            ...
            <div class="col-span-12 lg:col-span-7 space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @foreach($mainCategories as $index => $category)
                        @if($category->category_id != 7) {{-- Yedek Parça hariç --}}
                            ...
                            <a href="/shop/kategori/{{ $categorySlug }}"
                               class="group relative bg-white/70 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-gray-600 rounded-2xl p-6 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200 overflow-hidden">

                                <div class="relative z-10 flex items-center gap-4">
                                    {{-- Icon Container --}}
                                    <div class="relative">
                                        <div class="w-20 h-20 bg-white/40 dark:bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center border border-gray-200 dark:border-gray-600">
                                            @if($category->icon_class)
                ...
                <div class="flex flex-wrap gap-3">
                    {{-- Sıfır Ürün --}}
                    <div class="flex-1 min-w-[140px] bg-white/70 dark:bg-white/5 backdrop-blur-md border border-gray-200 dark:border-gray-600 rounded-xl px-4 py-3 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200 cursor-pointer">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-white/40 dark:bg-white/10 backdrop-blur-md rounded-lg flex items-center justify-center flex-shrink-0 border border-gray-200 dark:border-gray-600">
