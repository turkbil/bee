...
<div class="listening-history-component">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="text-muted">Dinleyici</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="text-muted">Farklı Şarkı</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-purple-lt h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <div class="h2 mb-0">{{ $this->stats['total_hours'] }}</div>
                            <div class="text-muted">Saat</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            @php
                $maxHourly = (!empty($this->hourlyStats) && max($this->hourlyStats) > 0) ? max($this->hourlyStats) : 1;
            @endphp
            <div class="d-flex align-items-end gap-1" style="height: 120px;">
                @foreach($this->hourlyStats as $hour => $plays)
                    <div class="flex-fill text-center" title="{{ sprintf('%02d:00', $hour) }} - {{ $plays }} dinleme">
                        <div class="bg-primary rounded-top" style="height: {{ ($plays / $maxHourly) * 100 }}px; min-height: 2px;"></div>
