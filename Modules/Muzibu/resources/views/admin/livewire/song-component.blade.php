                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 80px" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="{{ __('muzibu::admin.song.status') }}">
                                <button
                            ...
                            <tr class="hover-trigger" wire:key="row-{{ $song->song_id }}">
                                ...
                                <td wire:key="title-{{ $song->song_id }}" class="position-relative">
                                    ...
                                    @else
                                        <div class="d-flex align-items-center">
                                            <span
                                                class="editable-title pr-4">{{ $song->getTranslated('title', $currentSiteLocale) ?? $song->getTranslated('title', 'tr') }}</span>
                                ...
                                <td class="text-center align-middle">
                                    <button wire:click="toggleActive({{ $song->song_id }})"
                                        class="btn btn-icon btn-sm {{ $song->is_active ? 'text-muted bg-transparent' : 'text-red bg-transparent' }}">
                                        <!-- Loading Durumu -->
            ...
            @else
                <div class="d-flex justify-content-between align-items-center mb-0">
                    <p class="small text-muted mb-0">
                        Toplam <span class="fw-semibold">{{ $songs->total() }}</span> sonuç
                    </p>
                </div>
            @endif
        </div>
