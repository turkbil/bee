...
class EFX3_301_Forklift_3_Variants extends Seeder {
    public function run(): void {
        $m = DB::table('shop_products')->where('sku', 'EFX3-301')->first();
        if (!$m) {$this->command->error('❌ Master bulunamadı: EFX3-301'); return; }
        $variants = json_decode(<<<'JSON'
            [
                {
                    "sku": "EFX3-301-1070",
                    "variant_type": "catal-uzunlugu",
                    "title": "İXTİF EFX3 301 - 1070 mm Çatal",
                ...
                },
                {
                    "sku": "EFX3-301-1220",
                    "variant_type": "catal-uzunlugu",
                    "title": "İXTİF EFX3 301 - 1220 mm Çatal",
