...
class BlogCategoryModelTest extends TestCase
{
    ...
    /** @test */
    public function it_has_blogs_relationship(): void
    {
        $category = BlogCategory::factory()->create();

        $this->assertInstanceOf(\Illuminate\Database\Eloquent\Relations\HasMany::class, $category->blogs());
    }
    ...
    public function it_can_have_parent_category(): void
    {
        ...
        $child = BlogCategory::factory()->create(['parent_id' => $parent->category_id]);
    ...
    {
        $parent = BlogCategory::factory()->create();
        $child1 = BlogCategory::factory()->create(['parent_id' => $parent->category_id]);
        $child2 = BlogCategory::factory()->create(['parent_id' => $parent->category_id]);
    ...
    public function it_calculates_depth_level_correctly(): void
    {
        ...
        $child = BlogCategory::factory()->create(['parent_id' => $parent->category_id]);
        $grandchild = BlogCategory::factory()->create(['parent_id' => $child->category_id]);
    ...
    public function it_has_factory(): void
    {
        ...
        $this->assertDatabaseHas('blog_categories', ['category_id' => $category->category_id]);
    }
    ...
    public function it_prevents_circular_reference_in_depth_calculation(): void
    {
        ...
        $category = BlogCategory::factory()->create(['parent_id' => null]);
