    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col position-relative">
                <div wire:loading
                    wire:target="render, search, perPortfolio, sortBy, gotoPortfolio, previousPortfolio, nextPortfolio, delete, selectedItems, selectAll, bulkDelete, bulkToggleActive"
            ...
            <div class="col">
                <div class="d-flex align-items-center justify-content-end gap-3">
                    ...
                    <div style="min-width: 70px">
                        <select wire:model.live="perPortfolio" class="form-select">
